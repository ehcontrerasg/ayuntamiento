...
class PQRs extends ConexionClass
{
    ...
    public function obtenerDatosCliente($cod_inmueble)
    {
        ...
        I.ID_ZONA, I.UNIDADES_HAB, S.CONSUMO_MINIMO, L.EMAIL, L.DOCUMENTO, L.TELEFONO, SC.ID_GERENCIA,I.ID_PROCESO, I.CATASTRO, L.NOMBRE_CLI
    ...
    {
        $sql = "BEGIN SGC_P_INGRESA_PQR(TO_DATE('$fecha','DD/MM/YYYY HH24:MI:SS'),'$cod_inmueble','$nom_cli','$ced_cli','$direccion','$tel_cli','$mail_cli','$medio','$tipo','$motivo',TO_DATE('$fecha_res','DD/MM/YYYY hh24:mi:ss'),'$descripcion','$cod_ent','$id_punto','$num_caja','$coduser','$ger_inm','$area_res','$tel_cli_nuevo','$mail_cli_nuevo',:PMSGRESULT,:PCODRESULT);COMMIT;END;";
        //echo $sql;
        $resultado = oci_parse($this->_db, $sql);
...
//colocar $usr cuando se migren todos los reportes
    ...
    {
        $sql = "SELECT * FROM ( SELECT /*+ FIRST_ROWS(n) */ a.*, rownum rnum
        FROM (SELECT MR.DESC_MEDIO_REC MEDIOREC, TO_CHAR(FECHA_REGISTRO,'DD/MM/YYYY HH24:MI:SS')FECREG, M.DESC_MOTIVO_REC, P.DESCRIPCION, (U.NOM_USR||' '||U.APE_USR)USUARIO, P.COD_INMUEBLE, U.LOGIN
...
//////////consulta de reclamos anteriores
    ...
    public function InmueblesDeuda($proyecto, $sectorinicial, $sectorfinal, $rutainicial, $rutafinal, $uniinicial, $unifinal, $periodo1, $periodo2)
    {
        ...
        $sql = "SELECT MI.SERIAL, I.ID_TIPO_CLIENTE, I.CODIGO_INM,C.ALIAS, CL.NOMBRE_CLI, SUM(F.TOTAL)+SUM(F.TOTAL_DEBITO)-SUM(F.TOTAL_CREDITO)-SUM(F.TOTAL_PAGADO) TOTAL, CL.TELEFONO, I.ID_ESTADO, I.UNIDADES_HAB, I.CATASTRO, I.ID_PROCESO,
    ...
    {
        $sql = "BEGIN SGC_P_INGRESA_PQR_CATASTRAL(TO_DATE('$fecha','DD/MM/YYYY HH24:MI:SS'),'$nom_cli','$ced_cli','$direccion','$tel_cli','$cel_cli','$mail_cli','$medio','$tipo','$motivo',TO_DATE('$fecha_res','DD/MM/YYYY'),'$descripcion','$cod_ent','$id_punto','$num_caja','$coduser','$area_res',:PMSGRESULT,:PCODRESULT);COMMIT;END;";
        //echo $sql;
        $resultado = oci_parse($this->_db, $sql);
    ...
    {
        echo $sql = " SELECT I.CODIGO_INM, C.ALIAS, CL.DOCUMENTO, I.ID_SECTOR, I.ID_RUTA, I.DIRECCION, U.DESC_URBANIZACION, CL.TELEFONO, A.ID_USO, I.ID_ESTADO, P.FECHA_PAGO,
  ...
  WHERE P1.INM_CODIGO=I.CODIGO_INM AND
    ...
    P1.ESTADO='A'  AND
    P1.FECHA_PAGO BETWEEN  TO_DATE('$fecini 00:00:00','YYYY-MM-DD HH24:MI:SS') AND TO_DATE('2018-06-20 23:59:59','YYYY-MM-DD HH24:MI:SS')
  ) MONTO_PAGADO,
...
WHERE I.CODIGO_INM = C.CODIGO_INM
      ...
      AND I.ID_PROYECTO = '$proyecto'
      AND P.FECHA_PAGO BETWEEN TO_DATE('$fecini 00:00:00','YYYY-MM-DD HH24:MI:SS') AND TO_DATE('$fecfin 23:59:59','YYYY-MM-DD HH24:MI:SS')      AND I.CODIGO_INM IN (SELECT INM_CODIGO FROM DATA_CREDITO@LK_ACEA2 WHERE INM_CODIGO = I.CODIGO_INM)
ORDER BY CODIGO_INM
...
";
        ...
        $sql = "SELECT distinct pqr.codigo_pqr        Codigo,
                       ...
                       pqr.descripcion       desc_pqr,
                        ...
                        (select pf2.respuesta
                          ...
                          where pf2.codigo_pqr = pqr.codigo_pqr
                            ...
                            and rownum <= 1) respuesta,
                        (select dif_diaslab2( pqr.fecha_pqr, (select min(pf.fecha_salida)
                           from sgc_tt_pqr_flujo pf
                 ...
                 where i.codigo_inm = pqr.cod_inmueble
                   ...
                   AND pqr.fecha_pqr BETWEEN To_date('$fecIni', 'YYYY-MM-DD') and
                       to_date('$fecFin' || '23:59', 'YYYY-MM-DD HH24:MI')
    ...
    public function obtieneDatosPqrsYcatastrales($cod_pqr)
    {
        $sql = "SELECT P.COD_INMUEBLE, P.NOM_CLIENTE, P.DIR_CLIENTE, P.TEL_CLIENTE, P.DESCRIPCION, F.AREA_ACTUAL, F.ORDEN, P.GERENCIA
        FROM SGC_TT_PQRS P, SGC_TT_PQR_FLUJO F
        WHERE P.CODIGO_PQR = F.CODIGO_PQR
