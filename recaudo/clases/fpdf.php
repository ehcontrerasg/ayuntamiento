...
var $nCell;              //number of cells into multicell
...
function FPDF($orientation='P', $unit='mm', $format='A4', $largo='250')
{
	//Some checks
	$this->largo_hoja=$largo;
	$this->_dochecks();
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008), 'personal'=>array(612,320), 'a9'=>array(595.28,870.89), 'a7'=>array(150,$this->largo_hoja));
	if(is_string($format))
