...
if($datos_cliente["SIGLA_PROYECTO"]=="CAASD"){
 ...
 mayor a cinco días a partir de la fecha de recepción. Si transcurre dicho plazo y usted no ha recibido respuesta, favor llamar al
 ...
 Estimado cliente, una vez se recepcione en nuestras oficinas su solicitud, nos comprometemos a darle respuesta en un plazo no
 mayor a cinco días a partir de la fecha de recepción. Si transcurre dicho plazo y usted no ha recibido respuesta, favor llamar al
 teléfono (809) 523-6616 opción 2.";
}
...
<div id='p1' class='pageArea' style='overflow: hidden; position: relative; width: 935px; height: 1210px; margin-top:20px; margin-left:auto; margin-right:auto; background-color: white;'>
    ...
    <style type='text/css'>
        ...
        #ta_1{left:285px;bottom:994px;word-spacing:-0.2px;}
        ...
        #tr_1{left:71px;bottom:441px;letter-spacing:0.1px;word-spacing:0.2px;font-size:64px;}
        #tr_2{top:791px;left:71px;bottom:441px;letter-spacing:0.1px;word-spacing:0.2px;font-size:64px;}
        #ts_1{left:71px;bottom:422px;letter-spacing:0.1px;word-spacing:0.2px;font-size:64px;}
        #tt_1{top: 808px;left:71px;bottom:371px;letter-spacing:0.2px;word-spacing:-1.9px;}
        #tu_1{top: 813PX;left:525px;bottom:371px;letter-spacing:0.1px;}
...
-->    <!-- End page background -->
    ...
    <div id='ta_1' class='t s5'><b>AUTORIZACIÓN DE PAGO RECURRENTE</b></div>
    <div id='tb_1' class='t s4'><b>Por este medio autorizo a que se cargue automáticamente a mi tarjeta (abajo indicada), el pago del </div>
    ...
    <div id='tr_2' class='t s3'>El pago se efectuará al día siguiente de su fecha de facturación. </div>
    ...
    <div id='t10_1' class='t s3'>Edición No.: 05 </div>
