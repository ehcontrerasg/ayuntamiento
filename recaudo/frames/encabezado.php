...
<body>
<!-- 	<div id="header" style="background:linear-gradient(#333333,#FF8000,#FF8000);">
	<table width="99%" align="center">
	  <tr>
		  <td height="48" align="center"></td>
			<td width="9%" rowspan="2" align="center" style="color:#FFFFFF"><i class="fa fa-money fa-5x" style="vertical-align:top"></i> </td>
		  	<td height="48" colspan="4" align="left" class="td" style="vertical-align:bottom"><b>M&Oacute;DULO RECAUDO</b></td>
	  </tr>
  	  <tr>
		  <td width="24%" height="51" align="right"></td>
	  	  ...
	  	  <td width="28%" align="left" class="masthead"><font color="#CCC"><b>&nbsp;&nbsp;<?php echo $nomuser;?></b></font></td>
			  ...
			  <a class="btn btn-default btn-sm" href="./../../general/vistas/vista.consulta.php?mod=11" target="jobFrame">
...
<div class="menu" id="menu">
          <div class="logo-acea" >
            ...
            <div class="" >
            <h1><i class="fa fa-money" style="color: white;"></i>&nbsp; Módulo Recaudo</h1>
            </div>
            <div id="user-menu">
              ...
              <a class="btn btn-info btn-xs" href="./../../general/vistas/vista.consulta.php?mod=11" target="jobFrame">
