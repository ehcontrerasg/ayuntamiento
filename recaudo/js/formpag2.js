...
function oculta(){
    ...
    if(document.getElementById("medio").value == 4){
        ...
        document.getElementById("tdimporte1").style.display = 'none';
        document.getElementById("tdvuelta").style.display = 'none';
        document.getElementById("tdfavor").style.display = 'none';
        document.getElementById("tdpendiente").style.display = 'none';
        document.getElementById("tdbanco").style.display = 'none';
        document.getElementById("tdimporte2").style.display = 'none';
        document.getElementById("tdtipo").style.display = 'none';
        document.getElementById("tdimporte3").style.display = 'none';
        document.getElementById("tdaproba").style.display = 'none';
		document.getElementById("tdobservacion").style.display = 'none';
...
function calculavuelto(){
    var proyecto, monto,importe1,vuelta,favor, deuda, pendiente, importe2, importe3, arrayFact, tipClient;
    ...
    if(proyecto == 'BC') {
        ...
        favor = (parseFloat(importe1) + parseFloat(importe2) + parseFloat(importe3) - parseFloat(deuda));
        pendiente = parseFloat(deuda) - parseFloat(importe1) - parseFloat(importe2) - parseFloat(importe3);
        ...
        if(tipClient == 'CN') {
           ...
           /* for(var i =0; i<myarr.length; i++){
            ...
            if(importe1 > 0) {
                ...
                document.getElementById('importe1').value = parseFloat(totpag);
                importereal+=importe1;
            }
            if(importe2 > 0) {
                document.getElementById('importe2').value = parseFloat(totpag);
                importereal+=importe2;

            }
            if(importe3 > 0) {
                document.getElementById('importe3').value = parseFloat(totpag);
                importereal+=importe3;
            }
