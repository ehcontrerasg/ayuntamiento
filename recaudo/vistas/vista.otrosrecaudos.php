...
if ($verificarPermisos==true): ?>
    ...
    <!--    <meta name="viewport" content="width=device-width, initial-scale=1.0">-->
        ...
        <script type="text/javascript" src="../js/formOtrosRec.js?<?php echo time();?>"></script>
    ...
    <div id="content" style="padding:0px; width:100%; margin-left:0px">
        ...
        ?>
        <h3 class="panel-heading" style=" background-color:#FF8000; color:#FFFFFF; font-size:18px; width:100%" align="center">Ingreso de Otros Recaudos</h3>
        <form name="pagos" action="vista.otrosrecaudos.php" method="post" onKeyPress="return anular(event)">
            ...
            <div class="flexigrid" style="width:100%">
                <div class="mDiv">
                    <div style="background: linear-gradient(#F7F7F7,#F7F7F7); border-top:1px solid #ccc;" align="left">
                        ...
                        $c = new Pagos();
                        $resultado = $c->obtenerDatosFactura($cod_inmueble);
                        while (oci_fetch($resultado)) {
                            $valfactura += oci_result($resultado, 'TOTAL');
                        }oci_free_statement($resultado);
                        //$valfactura = $valfactura/3;



                            $c = new Reconexion();
                            $resultado = $c->getValRecByByInm($cod_inmueble);
                            while (oci_fetch($resultado)) {
                                $tarifa_reco = oci_result($resultado, 'VALOR_TARIFA');
                            }oci_free_statement($resultado);
                        if($ruta=='5157' && $tarifa_reco==1075){
                            $tarifa_reco=661;
                        }
                        ...
                        <table width="1231">
                            <tr>
                                <td width="163">
                                    ...
                                    <input readonly class="input" type="number" value="<?php echo $cod_inmueble ?>"  name="cod_inmueble" id="cod_inmueble" placeholder="Ingrese el Inmueble" />
                                ...
                                <td width="70" id="tddes_uso">
                                    Uso<br />
                                    <input type="text" name="des_uso" value="<?php echo $des_uso;?>" size="5" readonly class="input"/>
                                </td>
                            ...
                            <tr>
                                <td width="322" id="tdvalfact"  style="display: inline">Valor Minimo por factura RD$<br/>
                                    <input type="text" id="valfact" name="valfact" value="<?php echo $valfactura;?>" size="5" class="input" readonly>
                                </td>
                            </tr>
                            <?php
                            if($est_inm == 'SS' || $est_inm == 'PC'){
                                ...
                                <tr>
                                    <td colspan="6">
                                        <font size="3px" color="#FF0000">Valor Reconexion RD$ </font>
                                        <input value="<?php echo $tarifa_reco?>" readonly name="tarifarec" id="tarifarec"  />
                                <?php
                                if ($cod_pro=='BC'){
                                    ?>
                                    <input type="button" value="Diferir Valor reconexion"  style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#FF8000; color:#FF8000"
                                            name="diferir" id="diferir" class="btn btn btn-INFO"><i
                                                ></i>
                                    </input>
                                    </td>
                                <?php
                        ...
                        <table>
                            <tr class="person">
                                <td width="350">
                                    ...
                                    ?>
                                        <select name='medio' id="medio" class='input' onblur="oculta();habframe();"
                                                tabindex="1">
                                    ...
                                    <td width="300" style="display:none" id="tdconcepto">
                                        ...
                                        <select id="concepto" name="concepto" class="input"
                                                onchange="valida_conceptos();" tabindex="2">
                                            <option value="0" selected>Seleccione concepto...</option>
                                            <?php
                                            $c = new Pagos();
                                            $resultado = $c->seleccionaConcepto();
                                            while (oci_fetch($resultado)) {
                                    ...
                                    <td align="right" style="display:none;" id="botonpago">
                                        <button style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#FF8000; color:#FF8000; display:none"
                                                type="submit"
                                                name="procesar" id="procesar" class="btn btn btn-INFO"><i
                                                    class="fa fa-refresh"></i><b>&nbsp;Ingresar Recaudo</b>
                                        </button>
                                ...
                                <tr class="person">
                                    ...
                                    <td style="display:none; width:450px" id="tdmonto">
                                        ...
                                        <input type="number" name="monto" id="monto" value="<?php echo $monto; ?>"
                                               size="15" maxlength="9" placeholder="Ingrese monto" class="input"
                                               onchange="habframe()" onblur="calculavuelto()" tabindex="3"/>
                                    </td>
                                    <td style="display:none; width:300px" id="tdimporte1">
                                        Importe <font color="#FF0000">(RD$)</font><br/>
                                        <input type="number" name="importe1" id="importe1"
                                               value="<?php echo $importe1; ?>" size="15" maxlength="9"
                                               placeholder="Ingrese importe" class="input" onchange="habframe()"
                                               onblur="calculavuelto()" tabindex="4"/>
                                    </td>
                                    <td style="display:none; width:300px" id="tdvuelta">
                                        De vuelta <font color="#FF0000">(RD$)</font><br/>
                                        <input type="text" name="vuelta" id="vuelta" value="<?php echo $vuelta; ?>"
                                               size="15" maxlength="9" readonly class="input"/>
                                    </td>
                                </tr>
                                <tr class="person">
                                    <!--si es cheque-->
                                    <td style="display:none; width:450px" id="tdbanco">
                                        Banco Emisor<br/>
                                        <select name='banco' id="banco" class='input' onchange=" habframe();"
                                                tabindex="3">
                                    ...
                                    <td style="display:none; width:300px" id="tdcheque">
                                        N&deg; Cheque<br/>
                                        <input type="text" id="cheque" name="cheque" value="<?php echo $cheque; ?>"
                                               size="20" maxlength="18" placeholder="Ingrese N&deg; cheque"
                                               class="input" onchange=" habframe();" tabindex="4"/>
                                    </td>
                                    <td style="display:none; width:300px" id="tdimporte2">
                                        Importe <font color="#FF0000">(RD$)</font><br/>
                                        <input type="text" name="importe2" id="importe2"
                                               value="<?php echo $importe2; ?>" size="15" maxlength="9"
                                               placeholder="Ingrese importe" class="input" onchange=" habframe();"
                                               onblur="calculavuelto()" tabindex="5"/>
                                    </td>
                                </tr>
                                <tr class="person">
                                    <!--si es tarjeta-->
                                    <td style="display:none; width:350px" id="tdtipo">
                                        Tipo Tarjeta<br/>
                                        <select name='tarjeta' id="tarjeta" class='input' onchange=" habframe();"
                                                tabindex="3">
                                    ...
                                    <td style="display:none; width:300px" id="tdnumero">
                                        N&deg; Tarjeta<br/>
                                        <input type="text" id="numcard" name="numcard" value="<?php echo $numcard; ?>"
                                               size="20" maxlength="16" placeholder="Ingrese N&deg; tarjeta"
                                               class="input" onchange=" habframe();" tabindex="4"/>
                                    </td>
                                    <td style="display:none; width:300px" id="tdimporte3">
                                        Importe <font color="#FF0000">(RD$)</font><br/>
                                        <input type="text" name="importe3" id="importe3"
                                               value="<?php echo $importe3; ?>" size="15" maxlength="9"
                                               placeholder="Ingrese importe" class="input" onchange="habframe();"
                                               onblur="calculavuelto()" tabindex="5"/>
                                    </td>
                                    <td style="display:none; width:300px" id="tdaproba">
                                        N&deg; Aprobaci&oacute;n<br/>
                                        <input type="text" id="numaproba" name="numaproba"
                                               value="<?php echo $numaproba; ?>" size="20" maxlength="18"
                                               placeholder="Ingrese N&deg; aprobaci&oacute;n" class="input"
                                               onchange=" habframe();" tabindex="6"/>
                                    </td>
                                </tr>
                            </table>
                    </div>
