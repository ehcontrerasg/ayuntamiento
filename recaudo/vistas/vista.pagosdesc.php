...
if (true==true):?>
    ...
    include '../../facturacion/clases/class.reliquidacion.php';
...
//pasamos variables por post
    ...
    $facapag = $_POST['facapag'];
    $valfac = $_POST['valfac'];
    $direccion = $_POST['direccion'];
    $cod_cli = $_POST['cod_cli'];
    $est_inm = $_POST['est_inm'];
    $id_uso = $_POST['uso'];
    $apl_desc=$_POST['apldesc'];
    ...
    <head>
        ...
        <script type="text/javascript" src="../js/formpag2.js?29"></script>
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        ...
        if($monto > 0 && $importe > 0){
            ...
            if ($descuento>0) {
                $p = new reliquidacion();
                $result = $p->relconcepto2($cod_inmueble, $servicio, 200201, 202112, $descuento, 'NC', $coduser, 'Nota credito de ' . $descuento . ' aplicada por descuento debido a la cuarentena');
        ...
        if(!$result){
            echo "
                                ...
                                alert('error al reliquidar $mserror' );
                                </script>";
        }else{
        ...
        <form name="pagos" action="vista.pagos.php" method="post" onKeyPress="return anular(event)">
            <?
            echo 'apl desc'. $apl_desc;
            ?>
                        ...
                        <table>
                            <tr>
                                ...
                                while (oci_fetch($resultado)) {
                                    ...
                                    $codServicio = oci_result($resultado, 'COD_SERVICIO');
                                    $id_uso = oci_result($resultado, 'ID_USO');
                        ...
                        <table width="1000">
                            <tr>
                                ...
                                <td width="70">
                                    ...
                                    <input readonly class="input" type="text" value="<?php echo $cod_inmueble ?>"  name="cod_inmueble" id="cod_inmueble" placeholder="Ingrese el Inmueble" size="8"/>
                                </td>
                                <td width="120">
                                    Direcci&oacute;n<br />
                                    <input type="text" name="direccion" id="direccion" value="<?php echo $direccion;?>" size="20" readonly class="input"/>
                                </td>
                                <td width="250">
                                    Cliente<br />
                                    <input type="text" name="cod_cli" value="<?php echo $cod_cli;?>" size="6" readonly class="input" />
                                    <input type="text" name="nom_cli" value="<?php echo $nom_cli;?>" size="35" readonly class="input"/>
                                </td>
                                <td width="60">
                                    Acueducto<br />
                                    <input type="text" name="des_pro" value="<?php echo $des_pro;?>" size="8" readonly class="input"/>
                                </td>
                                <td width="62">
                                    Estado<br />
                                ...
                                <td width="62">
                                    uso<br />
                                    <input type="text" id="uso" name="uso" value="<?php echo $id_uso;?>" size="4" readonly class="input" />
                                </td>
            ...
            <div class="flexigrid" style="width:100%">
                <div class="mDiv">
                    <div align="left"><b>Datos deuda</b></div>
                </div>
            </div>
                        ...
                        <table width="800">
                            <tr>
                                ...
                                <td width="90">
                                    ...
                                    $c = new Pagos();
                                    $resultado = $c->obtieneDeudaNumFact($cod_inmueble,$facapag);
                                    while (oci_fetch($resultado)) {
                                        $valfac = oci_result($resultado, 'DEUDA') ;
                                    ...
                                    if (($id_uso=='C' OR $id_uso=='R' OR $id_uso=='M' ) and $cod_pro=='SD' and $apl_desc=='si' ){
                                    ...
                                    <input type="text" name="deuda" id="deuda" value="<?php echo $deuda;?>" size="8" maxlength="9" class="input" style="color:#FF0000" onBlur="calculavuelto()"/>
                                </td>
                                ...
                                <td width="70">
                                    Fact Pendientes<br />
                                    <input type="text" name="facpend" id="facpend" value="<?php echo $facpend;?>" size="4"  readonly class="input" style="color:#FF0000"  />
                                </td>

                                <td width="70">
                                    Fact a pagar<br />
                                    <input type="text" onChange="recarga();" name="facapag" id="facapag" value="<?php echo $facapag;?>" size="4"   class="input" style="color:#FF0000"  />
                                </td>

                                <td width="70">
                                    Valor facturas<br />
                                    <input type="text" readonly name="valfac" id="valfac" value="<?php echo $valfac;?>" size="4"   class="input" style="color:#FF0000"  />
                                </td>

                                <td width="70">
                                    descuento<br />

                                    <input readonly class="input" type="text" value="<?php echo round($valfac*$factorDesc) ?>"  name="desc" id="desc" placeholder="Ingrese el Inmueble" size="8"/>
                                </td>


                                <td width="70">
                                    aplica descuento<br />
                                    <select  onChange="recarga();"    name="apldesc" id="apldesc" />
                                ...
                                <td width="70">
                                    Total a pagar<br />
                                    <input type="text" name="tot_pag" id="tot_pag" value="<?php echo $valfac-round($valfac*$factorDesc);?>" size="4"  readonly class="input" style="color:#FF0000"  />
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <input type="hidden" id="id_servicio" name="id_servicio" value="<?php echo $codServicio;?>"/>
        </form>
    </div>
    <script type="text/javascript">
        inicioFormPago();
        ...
        function recarga2() {
            //document.asignacion_mant.operario.selectedIndex = 0;
            alert(document.getElementById('apldesc').checked)
        }
    </script>
    </body>
    </html>
