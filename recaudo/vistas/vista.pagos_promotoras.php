...
//pasamos variables por post
    ...
    <head>
        ...
        <script type="text/javascript" src="../js/formpag.js?21"></script>
        <link href="../../font-awesome/css/font-awesome.min.css?4" rel="stylesheet" />
        <link href="../css/pagosgen.css?4" rel="stylesheet" />
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        ...
        if($monto > 0 && $importe > 0){
            ...
            $origen = 'P';
            $c = new Pagos();
            $bandera = $c->IngresaPagoTransito($cod_inmueble, $id_punto, $fecha, $medio, $importe1, 'Pago Promotora', $coduser);
        ...
        <?php
            ...
            echo "
                <script type='text/javascript'>
                    window.open('vista.imprime_recibo_promotora.php?cod_inmueble=$cod_inmueble&num_caja=$num_caja&des_punto=$des_punto&des_ent=$des_ent&nom_cli=$nom_cli&fecha=$fecha&deuda=$deuda&monto=$monto&vuelta=$vuelta&medio=$medio&favor=$favor');
                    window.location='vista.tipo_pago_promotora.php';
                </script>";
        }
        ...
        ?>
        <h3 class="panel-heading" style=" background-color:#FF8000; color:#FFFFFF; font-size:18px; width:1120px" align="center">Ingreso de Pagos</h3>
        <form name="pagos" action="vista.pagos_promotoras.php" method="post" onKeyPress="return anular(event)">
            <!--span class="flexigrid" style="width:100%">
                <span class="mDiv">
                    <span align="left"><b>Datos Para Pago</b></span>
                </span>
            </span-->
            <!--div class="flexigrid" style="width:100%"-->
            <span class="mDiv">
                <span style="background: linear-gradient(#F7F7F7,#F7F7F7); border-top:1px solid #ccc;" align="left">
                    <?php
                    ...
                    <span class="datoForm col1">
                        <span class="col-xs-12 col-sm-3 col-md-2 col-lg-2" style="text-align:left">
                            Acueducto<br />
            ...
            <!--/div-->
            <span class="flexigrid" style="width:100%; display:block" id="divdatosformapago">
                <span class="mDiv">
                    <span style="background: linear-gradient(#F7F7F7,#F7F7F7); border-top:1px solid #ccc;" align="left">
                        <?php
                        ...
                        <span class="datoForm col1">
                            <span class="col-xs-12 col-sm-3 col-md-2 col-lg-2" style="text-align:left">
                                ...
                                if($cod_ent == '901' && $id_punto == '440'){
                                    ?>
                                    <select name='medio' id="medio" class='input' onchange='oculta();' tabindex="1" >
                            ...
                            <span style="display:none; text-align: left" id="tdmonto" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                            ...
                            <span style="display:none; text-align: left" id="tdimporte1" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                        ...
                        <span class="datoForm col1">
                            <span style="display:none; text-align: left" id="tdpendiente"  class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            ...
                            <span style="display:none; text-align: left" id="tdfavor" class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            ...
                            <!--si es efectivo-->
                            <span style="display:none; text-align: left" id="tdvuelta" class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                        ...
                        <span class="datoForm col1">
                            <!--si es cheque-->
                            <span style="display:none; text-align: left" id="tdbanco" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                                Banco Emisor<br />
                            ...
                            <span style="display:none; text-align: left" id="tdimporte2" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                        ...
                        <span class="datoForm col1">
                            <!--si es tarjeta-->
                            <span style="display:none; text-align: left" id="tdtipo" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                                Tipo Tarjeta<br />
                            ...
                            <span style="display:none; text-align: left" id="tdaproba" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                            ...
                            <span style="display:none; text-align: left" id="tdimporte3" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                        ...
                        <span class="datoForm col1">
                            <span style="display:none; text-align: left" id="tdobservacion" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                                <?php
                        ...
                        <span class="datoForm col1">
                            <span  style="display:none;" id="botonpago" class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
                                <button style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#FF8000; color:#FF8000; display:none" type="submit" name="procesar" id="procesar"class="btn btn btn-INFO"><i class="fa fa-refresh"></i><b>&nbsp;Generar Pago</b>
                                </button>
                            </span>
                        </span>
                    </span>
