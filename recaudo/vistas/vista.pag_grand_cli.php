...
//pasamos variables por post
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        <h3 class="panel-heading" style=" background-color:#FF8000; color:#FFFFFF; font-size:18px; width:1120px" align="center">Pagos Grandes</h3>
                    ...
                    <div style="background: linear-gradient(#F7F7F7,#F7F7F7); border-top:1px solid #ccc;" align="left">
                        <table width="1115">
                            ...
                            <tr>
                                ...
                                <td width="327">
                                    <input type="radio" name="tipo_archivo" value="XLS" onClick="fcargue(this.value);" required>GC
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="5">
                                    ...
                                    <div disabled="disabled">
                                        <iframe src="cargue_archivo_gc_xls.php" id="prueba" name="prueba" width="100%" marginheight="0" marginwidth="0" noresize scrolling="auto"
                                                frameborder="0" height="200" style="background-color: #E0E0E0"></iframe>
                                        <iframe src="cargue_archivo_gc_txt.php" id="prueba" name="prueba" width="100%" marginheight="0" marginwidth="0" noresize scrolling="auto"
                                                frameborder="0" height="200" style="background-color: #E0E0E0"></iframe>
                                    </div>
                                </td>
                            </tr>
    ...
    <script type="text/javascript" language="javascript">
            ...
            for (i = 0; i < document.cargue.elements.length; i++) {
                if (document.cargue.elements[i].type == "radio") {
                    if (document.cargue.elements[i].checked && document.cargue.elements[i].value == "XLS") {
                        document.cargue.action = "cargue_archivo_gc_xls.php";
                        ok = true; }
        ...
        function fcargue(tipo) { //alert(tipo);
            if (tipo == "XLS") document.cargue.action = "cargue_archivo_gc_xls.php";
