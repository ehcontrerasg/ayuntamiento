...
//pasamos variables por post
    ...
    <div style="padding:0px; width:1120px; margin-left:0px">
        ...
        if($cod_inmueble != ''){
            ...
            /*if($est_inm <> 'SS' && $est_inm <> 'PC' && $deuda <= 0 && $serial == ''){
            ?>
                <script>
                    swal({
           ...
           /* if($est_inm <> 'SS' && $est_inm <> 'PC' && $deuda <= 0 && trim($serial) <> ''){
            ...
            /*if(($est_inm <> 'SS' && $est_inm <> 'PC' && $deuda > 0) || ($est_inm == 'PC' && $excluido==1)){
            ?>
                <script>
            ...
            ?>
                ...
                ?>
                <script>
                    window.location='vista.pagos_promotoras.php?cod_inmueble=<?php echo $cod_inm?>';
                </script>
            <?php
            }
        }
        ...
        <h3 class="panel-heading" style=" background-color:#FF8000; color:#FFFFFF; font-size:18px; width:1120px" align="center">Ingreso de Pagos Promotoras</h3>
        <form name="tipopagos" action="vista.tipo_pago_promotora.php" method="get">
