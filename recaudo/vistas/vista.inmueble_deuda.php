...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <!--logica pag    -->
        <script type="text/javascript" src="../js/repInmDeuda.js?1"></script>
    </head>
    <body>
    <header>
        <div class="cabecera">
        ...
        <article>
            <form onSubmit="return false" id="genRepInmDeudaForm">
                ...
                <div class="divfiltros">
                    ...
                    <div class="contenedor">
                        <button style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#FF8000; color:#FF8000; display:block;"  id="butGenInmDeuda">Generar Reporte</button>
                    </div>
                </div>
            </form>
        </article>
