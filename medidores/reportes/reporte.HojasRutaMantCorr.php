...
$datos=$a->getMantCorByProyProManzOper($proyecto,$proIni,$proFin,$codSis,$manIni,$manFin,$usr_asignado,$periodo);
...
//    $pdf->Text(70,282,utf8_decode("Entrego Constancia:"));
//    $pdf->SetX(105);
//    $pdf->Cell(4,4,"",1,3,'C',true);
//    $pdf->Text(100,282,utf8_decode("Si"));
//    $pdf->SetY(278);
//
//    $pdf->SetX(115);
//    $pdf->Cell(4,4,"",1,3,'C',true);
//    $pdf->Text(110,282,utf8_decode("No"));
