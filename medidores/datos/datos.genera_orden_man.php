...
if($tipo=='flexy'){
    ...
    $l=new Medidor();
    $registros=$l->getDatInmMedByAcuProManMedEst($proyecto,$proIni,$proFin,$codSis,$manIni,$manFin,"S","A");
...
if($tipo=='genOrdMan'){
    ...
    $l=new Medidor();
    $bandera=$l->generaOrdenesMantMed($proyecto,$proIni,$proFin,$codSis,$manIni,$manFin,$cod,$motivo,$usr_asignado,$cod,$desc);
    if($bandera){
