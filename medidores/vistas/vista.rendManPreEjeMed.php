...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <!--pag-->
        <script type="text/javascript" src="../js/rendManPreEje.js?<?echo time();?>"></script>
    ...
    <header class="cabeceraTit fondMed">
        Rendimiento de Mantenimiento Preventivo Realizado por dia por fecha de ejecucion
    </header>

    <section class="contenido">
        <article>
            <form onsubmit="return false" id="rendManPreEjeForm" >
              <span class="datoForm col1">
                  <span class="titDato numCont1">Acueducto:</span>
                  <span class="inpDatp numCont2"><select required name="proyecto" select id="rendManPreEjeSelPro" ></select></span>
                  <span class="titDato numCont1">Sector:</span>
                  <span class="inpDatp numCont2"><select   name="sector"  id="rendManPreEjeSelSec" ></select></span>
                  <span class="titDato numCont1">Fecha Ini:</span>
                  <span class="inpDatp numCont1"><input  id="rendManPreEjeFecIni" name="fecIni" type="date" ></span>
                  <span class="titDato numCont1">Fecha Fin:</span>
                  <span class="inpDatp numCont1"><input  id="rendManPreEjeFecFin" name="fecFin" type="date"  ></span>
              </span>
                <span class="datoForm col1">
