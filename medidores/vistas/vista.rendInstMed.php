...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <!--pag-->
        <script type="text/javascript" src="../js/rendInstMed.js?20"></script>
    ...
    <header class="cabeceraTit fondMed">
        Rendimiento de Instalacion Realizado por dia por fecha asignacion
    </header>

    <section class="contenido">
        <article>
            <form onsubmit="return false" id="rendInstMedForm" >
              <span class="datoForm col1">
                  <span class="titDato numCont1">Acueducto:</span>
                  <span class="inpDatp numCont2"><select required name="proyecto" select id="rendInstMedSelPro" ></select></span>
                  <span class="titDato numCont1">Sector:</span>
                  <span class="inpDatp numCont2"><select   name="sector"  id="rendInstMedSelSec" ></select></span>
                  <span class="titDato numCont1">Fecha Ini:</span>
                  <span class="inpDatp numCont1"><input  id="rendInstMedFecIni" name="fecIni" type="date" ></span>
                  <span class="titDato numCont1">Fecha Fin:</span>
                  <span class="inpDatp numCont1"><input  id="rendInstMedFecFin" name="fecFin" type="date"  ></span>
              </span>
                <span class="datoForm col1">
