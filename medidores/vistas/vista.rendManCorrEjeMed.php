...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <!--pag-->
        <script type="text/javascript" src="../js/rendManCorrEje.js?<?echo time();?>"></script>
    ...
    <header class="cabeceraTit fondMed">
        Rendimiento de Mantenimiento Correctivo Realizado por dia por fecha de ejecucion
    </header>

    <section class="contenido">
        <article>
            <form onsubmit="return false" id="rendManCorrEjeForm" >
              <span class="datoForm col1">
                  <span class="titDato numCont1">Acueducto:</span>
                  <span class="inpDatp numCont2"><select required name="proyecto" select id="rendManCorrEjeSelPro" ></select></span>
                  <span class="titDato numCont1">Sector:</span>
                  <span class="inpDatp numCont2"><select   name="sector"  id="rendManCorrEjeSelSec" ></select></span>
                  <span class="titDato numCont1">Fecha Ini:</span>
                  <span class="inpDatp numCont1"><input  id="rendManCorrEjeFecIni" name="fecIni" type="date" ></span>
                  <span class="titDato numCont1">Fecha Fin:</span>
                  <span class="inpDatp numCont1"><input  id="rendManCorrEjeFecFin" name="fecFin" type="date"  ></span>
              </span>
                <span class="datoForm col1">
        ...
        <article class="detalle_ruta">
            <div class="contenedor-flexy2" >
                <table id="flexRendManCorrEjeDet">
                </table>
            </div>
        </article>
