...
<body>
	<!-- <div id="header" style="background:linear-gradient(#333333,#B51604,#B51604);">
		<table width="99%" align="center">
		  <tr>
			  <td height="48" align="center"></td>
				<td width="9%" rowspan="2" align="center" style="color:#FFFFFF"><i class="fa fa-industry fa-5x" style="vertical-align:top"></i> </td>
			  	<td height="48" colspan="4" align="left" class="td" style="vertical-align:bottom"><b>M&Oacute;DULO GRANDES CLIENTES</b></td>
		  </tr>
	  	  <tr>
			  <td width="24%" height="51" align="right"></td>
		  	  ...
		  	  <td width="28%" align="left" class="masthead"><font color="#CCC"><b>&nbsp;&nbsp;<?php echo $nomuser;?></b></font></td>
				  ...
				  <a class="btn btn-default btn-sm" href="./../../general/vistas/vista.consulta.php?mod=13" target="jobFrame">
	...
	<div class="menu" id="menu">
          <div class="logo-acea" >
            ...
            <div class="" >
            <h1><i class="fa fa-ban fa-industry" style="color: white;"></i>&nbsp; Módulo Grandes Usuarios</h1>
            </div>
            <div id="user-menu">
              ...
              <a class="btn btn-info btn-xs" href="./../../general/vistas/vista.consulta.php?mod=13" target="jobFrame">
