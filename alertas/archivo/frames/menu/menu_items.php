<?php	
	...
	while (oci_fetch($stid)) {
		...
		$sql2 = "SELECT DISTINCT M.DESC_MENU, M.URL FROM SGC_TP_MENUS M, SGC_TP_PERFILES P  WHERE M.URL IS NOT NULL AND M.ID_PADRE = $cod_menu AND  P.ID_MENU=M.ID_MENU AND P.ID_USUARIO='$coduser'";
