...
<head>
    ...
    <script type="text/javascript" src="../js/consulta.js?2"></script>
     ...
     <article>
         ...
         <div class="contenedor-flexy" >
             <div class="tabber" id="tab">
                 ...
                 <div class="tabbertab" title="Medidor" id="tabMedHijos">
                     <div class="contenedor-flexy" >
                         <table id="flexMedHij">
                         </table>
                     </div>
                 ...
                 <div class="tabbertab" title="Facturas">
                     ...
                     <div class="flexigrid" >
                         ...
                         <object id="ifpdf" name="ifpdf" style="display: block;float: left;width: 600px;height: 259px " ></object>
