...
if($_POST['bandera2']=='true'){

    $url=$_POST['url'];
    $codUsuario = $_SESSION["codigo"];
    echo $url.$codUsuario;
    include  "../../clases/class.SolicitarVentana.php";
    $solicitud = new SolicitarVentana();
    $solicitud ->InsertarSolicitud($url,$codUsuario);
...
<html>
    <head>
        ...
        <script src="../../js/SolicitarVentanaEmergente.js"></script>
    ...
    <body>
        ...
        <?} else {?>
            ...
            <form action="/acea/general/vistas/vista.PlantillaError2.php"  autocomplete="on" method="post">
                <input name="url" type="hidden" value=<?echo $url;?>/>
                <input type="submit" value="Solicitar permiso">

                <input type="hidden" name="bandera2" value="true" class="btn-success" >
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/acea/general/vistas/vista.PlantillaError2.php" id="frmLogin" autocomplete="on" method="post">
