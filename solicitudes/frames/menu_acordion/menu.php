...
$sql = "SELECT M.ID_MENU, M.DESC_MENU, M.ICONO, M.ORDEN
	FROM SGC_TP_MENUS M, SGC_TP_PERFILES_TI P,SGC_TT_USUARIOS U
	WHERE M.ID_MENU = P.ID_MENU AND M.ID_PADRE = 0
	AND P.ID_USUARIO = '$coduser' AND M.ACTIVO = 'S'
	AND U.ID_USUARIO = P.ID_USUARIO AND U.SOLICITUDES='S'
	AND (M.ID_MODULO = 18) ORDER BY ORDEN ASC";
...
$sql2 = "SELECT DISTINCT M.DESC_MENU, M.URL, M.ORDEN
		FROM SGC_TP_MENUS M, SGC_TP_PERFILES_TI P
