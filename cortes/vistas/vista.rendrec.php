...
//Conectamos con la base de datos
    ...
    <head>
        ...
        <script type="text/javascript" src="../js/rendRec.js?6"></script>
    ...
    <div id="content" style="padding:0px; width:1120px;">
        <form name="rendimiento" action="vista.rendrec.php" method="post" onsubmit="return rend();">
            <?php
	...
	showDialog('Advertencia','Seleccione el Acueducto','warning',3);
            ...
            <h3 class="panel-heading" style=" background-color:#88A247; color:#FFFFFF; font-size:18px; width:1120px;" align="center">Rendimiento de Reconexiones por fecha de asignacion</h3>
            <div style="text-align:center; width:1120px; margin-left:0px">
                <table width="100%" border="1" bordercolor="#CCCCCC" align="center">
                    <tr>
                        ...
                        FROM SGC_TT_REGISTRO_RECONEXION C, SGC_TP_SECTORES S, SGC_TT_INMUEBLES I
                        WHERE
            ...
            if (($sector != "" && $contratista != "" ) || ($proyecto != "" && $fecini != "" && $fecfin != "" ) ){
                ...
                $nomrepo = 'Rendimiento Operarios Reconexion - ';
                //echo "../datos/datos.rendrec.php?proyecto=$proyecto&periodo=$periodo&sector=$sector&fecini=$fecini&fecfin=$fecfin";
                ?>
		...
		<div class="mDiv">
            ...
            <div style="background-color:rgb(255,255,255)">
                ...
                <script type="text/javascript">
                    ...
                    $("#flex1").flexigrid	(
                        {
                            url: '../datos/datos.rendrec.php?proyecto=<?php echo $proyecto;?>&sector=<?php echo $sector;?>&fecini=<?php echo $fecini;?>&fecfin=<?php echo $fecfin;?>&selCon=<?php echo $contratista;?>',
                ...
                <iframe id="detallerutaoperec" style="border-left:0px solid #ccc; border-right:0px solid #ccc"></iframe>
                <iframe id="rutageorec" style="border-left:0px solid #ccc; border-left:0px solid #ccc"></iframe>
                <?php
            }
            ?>
        </form>
