...
//x=xgeo;
    ...
    <form action="acea_google.php"  name="formulario" method="post" >
        ...
        $l=new Reconexion();
        $registros=$l->getPriCoorByRutFecUsu($cod_ruta, $fechaini, $fechafin, $operario,$fecAsig);
        ...
        $l=new Reconexion();
        $registros=$l->getUltCoorByRutFecUsu($cod_ruta, $fechaini, $fechafin, $operario);
        while (oci_fetch($registros)) {
            $xi = oci_result($registros, 'LONGITUD');
            $yi = oci_result($registros, 'LATITUD');
        ...
        $l=new Reconexion();
        $registros=$l->getResCoorByRutFecUsu($cod_ruta, $fechaini, $fechafin, $operario,$id_sistema_ini,$id_sistema_fin);
        $i=0;
        while (oci_fetch($registros)) {
            $i=$i+1;
        ...
        $array_coordenadas = "";
        $l=new Reconexion();
        $registros=$l->getTotCoorByRutFecUsu($cod_ruta, $fechaini, $fechafin, $operario);
        while (oci_fetch($registros)) {
            $x = oci_result($registros, 'LONGITUD');
            $y = oci_result($registros, 'LATITUD');
            $array_y =  "$y";
