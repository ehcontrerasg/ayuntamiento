...
if ($verificarPermisos==true): ?>
    ...
    <head>
        <meta  charset=UTF-8" />
        <title>Reporte de inspecciones realizadas por fecha ejecucion</title>
        <!-- alertas -->
        <link rel="stylesheet" type="text/css" href="../../css/sweetalert.css"/>
        <script type="text/javascript" src="../../js/sweetalert.min.js"></script>
        <script type="text/javascript" src="../../js/jquery.min.js"></script>
        <!--pag-->
        <script type="text/javascript" src="../js/insXFecEjec.js?10"></script>
    ...
    <header class="cabeceraTit fondCorte">
        Reporte inspecciones por fecha de ejecucion
    </header>
