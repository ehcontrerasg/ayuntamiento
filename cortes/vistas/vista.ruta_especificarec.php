...
<form action="acea_google.php"  name="formulario" method="post" >
 ...
 FROM SGC_TT_registro_reconexion rf
 WHERE RF.ID_INMUEBLE IN ($cod_inms)  AND RF.FECHA_EJE between to_date('$fecini','YYYY-MM-DD')  and to_date('$fecfin','YYYY-MM-DD')
 and RF.USR_EJE='$operario'
  AND LONGITUD <> 0
