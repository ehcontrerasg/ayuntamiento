...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../../css/bootstrap/css/bootstrap.css?<? echo time();?>">
        <!--Lógica JS-->
        <script type="text/javascript" src="../js/gestionPqrCortes.js?<? echo time();?>"></script>
        <!-- alertas -->
        <link rel="stylesheet" type="text/css" href="../../css/sweetalert.css?0" />
        <script type="text/javascript" src="../../js/sweetalert.min.js?0"></script>
        <!--Estilos-->
        <link rel="stylesheet" type="text/css" href="../css/gestion_pqr.css?<?echo time();?>">
    ...
    <form name="reporte_hisfac" action="vista.gestion_pqr.php" method="post" >
        <h3 class="panel-heading" style=" background-color:#88A247; color:#FFFFFF; font-size:18px; width:1120px; margin-top:-5px" align="center">Gesti&oacute;n Solicitudes, Reclamos y Consultas</h3>
    ...
    if(isset($_REQUEST["Imprimir"])){
        ?>
        <script type="text/javascript">window.open('../../medidores/vistas/vista.docmasivo_pqr.php?tipo_pqr=<?php echo $tipo_pqr;?>&proyecto=<?php echo $proyecto;?>&secini=<?php echo $secini;?>&secfin=<?php echo $secfin;?>&rutini=<?php echo $rutini;?>&rutfin=<?php echo $rutfin;?>&fecini=<?php echo $fecini;?>&fecfin=<?php echo $fecfin;?>&cod_inmueble=<?php echo $cod_inmueble;?>&area_user=<?php echo 3;?>')</script>
        <?php
    }
    ...
    if(isset($_REQUEST["Buscar"])){
        ...
        <script type="text/javascript">
            ...
            $("#flex1").flexigrid	(
                {
                    url: './../datos/datos.gestion_pqr.php?tipo_pqr=<?php echo $tipo_pqr;?>&proyecto=<?php echo $proyecto;?>&secini=<?php echo $secini;?>&secfin=<?php echo $secfin;?>&rutini=<?php echo $rutini;?>&rutfin=<?php echo $rutfin;?>&fecini=<?php echo $fecini;?>&fecfin=<?php echo $fecfin;?>&cod_inmueble=<?php echo $cod_inmueble;?>&area_user=<?php echo $area_user;?>&tip=getReporte',
                    dataType: 'json',
                    colModel : [
                        ...
                        ?>
                        /*{display: 'Asignación de corte', name: 'asignacioncorte', width: 179, sortable: true, align: 'center'},*/
                    ],
                    /*searchitems : [
    ...
    <!--Modal asignacion de operario-->
    <div class="modal" id="modalAsignacionCorte" tabindex="-1" >
        <div class="modal-dialog" >
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Asignación de corte</h5>
                    ...
                    <div class="modal-body">
                        <p>
                            <label style="color:#da7046; font-weight: bold" id="avisoAsignacionCorte"></label>
                        </p>
                        <p>
                            <label class="titulo">Código PQR:</label>
                            <label id="lblCodigoPqr" class="campo"></label>
                        </p>
                        <p>
                            <label class="titulo">Inmueble:</label>
                            <label id="lblInmueble" class="campo"></label>
                        </p>
                        <p>
                            <label class="titulo">Dirección:</label>
                            <label id="lblDireccion" class="campo"></label>
                        </p>
                        <p>
                            <label class="titulo">Zona:</label>
                            <label id="lblZona" class="campo"></label>
                        </p>
                        <p>
                            <label class="titulo">Operario:</label>
                            <select name="operario" id="slcOperario"></select>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button value="Asignar" onclick="asignarCorte()" class="btn btn-primary" id="btnAsignarCorte">Asignar</button>
                        <input type="button" value="Eliminar asignación" class="btn btn-danger" id="btnEliminarAsignacion">
