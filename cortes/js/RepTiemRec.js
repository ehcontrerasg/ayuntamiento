...
function inicio(){
    ...
    butGeneraRep=document.getElementById("butRepTiemRec");
    selPeriodo=document.getElementById("selPeriodo");
    selProyecto=document.getElementById("selPoyecto");
    ifReporte= document.getElementById("ifRepTiemRec");
...
function generaReporte(){
    if(valida()){
        ...
        ifReporte.src="../datos/datos.repTiemRec.php?periodo="+periodo+"&tipo=rep"+"&pro="+proyecto+"&selCon="+contratista;
    }
}
...
function llenarSelPer(){
    ...
    xmlhttp.open("POST", "../datos/datos.repTiemRec.php", true);   // async
