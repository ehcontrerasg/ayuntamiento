...
function inicio(){
    ...
    iframePdf=document.getElementById("ifHojaIns");
    ...
    butProcesar=document.getElementById("butOrdIns");
    butProcesar.addEventListener("click",procHojaIns);

    radbMetodo=document.getElementsByName("rbModo");
    formHojaIns=document.getElementById("formHojasIns");

    fechaAsig = document.getElementById('fechaAsig');
    inmueble = document.getElementById('inmueble');
    llenarSelProy();
}
...
function procHojaIns(){
    ...
    var inm = inmueble.value;
    iframePdf.src="../datos/datos.hojaIns.php?tipo="+tipo+"&proy="+pro+"&sec="+sec+"&zon="+zon+"&oper="+oper+"&inm="+inm+"&fecha="+fecha;
}
...
function llenarSelProy(){
    ...
    xmlhttp.open("POST", "../datos/datos.hojaIns.php", true);   // async
