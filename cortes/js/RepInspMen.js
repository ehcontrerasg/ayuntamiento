...
function generaReporte() {
    if (valida()) {
        ...
        ifReporte.src = "../datos/datos.repInspMen.php?periodo=" + periodo + "&tipo=rep" + "&pro=" + proyeto+"&selCon="+contratista;
    }
}
...
function llenarSelPer() {
    ...
    xmlhttp.open("POST", "../datos/datos.repResMen.php", true); // async
...
function llenarSelPro() {
    ...
    xmlhttp.open("POST", "../datos/datos.repInspMen.php", true); // async
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
