...
include_once"../../clases/class.corteReconexion.php";
if($tip=='flexy'){
    ...
    function countRec($fname,$tname,$where,$sort,$fini,$ffin) {
        $l=new Corte();
        $valores=$l->getCantDatDiarReconexionFlexy($fname, $tname,$where,$fini,$ffin);
    ...
    $tname=" SGC_TT_REGISTRO_RECONEXION RC, SGC_TT_INMUEBLES INM,SGC_TT_USUARIOS USR";
    ...
    $registros=$l->getDatDiarReconexionFlexy($where, $sort, $start, $end,$fecini,$fecfin);
