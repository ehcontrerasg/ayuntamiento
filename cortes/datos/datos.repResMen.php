...
if ($tipo == "rep") {
    ...
    $a    = new Corte();
    $std  = $a->getTipoCortePorSec($periodo, $proyecto,$contratista);
    $posy = 43;
    ...
    $b    = new Corte();
    $std  = $b->getCantSecPorPer($periodo, $proyecto,$contratista);
    $posy = 43;
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont('times', '', 9);
    $totVisitado    = 0;
    ...
    while (oci_fetch($std)) {
        ...
        $totInsp += $inspecciones       = oci_result($std, "INSPECCIONES"); //Campo agregado
        ...
        $pdf->SetY($posy);
        $pdf->SetX(126);
        $totPagos += $pagos = $b->getPagoGroupSecPerBySecPer($periodo, $sector);
        $pdf->Cell(9, 5, $pagos, 1, 3, 'C', false);

        $b                        = new Pago();
        $totPagosCor += $pagosCor = $b->GerPagCorGroupSecPerBySecPer($periodo, $sector,$contratista);
        $pdf->SetY($posy);
        $pdf->SetX(135);
        $pdf->Cell(16, 5, $pagosCor, 1, 3, 'C', false);

        $b                      = new Pago();
        $totCantRec += $cantRec = $b->getPagRecByPerSec($periodo, $sector,$contratista);
        $pdf->SetY($posy);
        $pdf->SetX(151);
        $pdf->Cell(19, 5, $cantRec, 1, 3, 'C', false);

        $b                    = new Pago();
        $totMonRec += $monRec = $b->getTotValRecBySecPer($periodo, $sector,$contratista);
        $pdf->SetY($posy);
        $pdf->SetX(170);
...
///////////////////////// GERENCIA ESTE/////////////////////////////////////
    ...
    $pdf->SetY($posy + 35);
    $pdf->SetX(51);
    $total += $corEfecNoMeEste = $b->getCantGerTipo($periodo, 'S', 'E', $proyecto,$contratista);
    ...
    $b                       = new Corte();
    $total += $corEfecMeEste = $b->getCantGerTipo($periodo, 'N', 'E', $proyecto,$contratista);
    $pdf->SetY($posy + 40);
    $pdf->SetX(51);
    ...
    $pdf->SetY($posy + 50);
    $pdf->SetX(51);
    $total += $pagRecMedEste = $b->getCantRecPagByPerTipGerPro($periodo, 'S', 'E', $proyecto,$contratista);
    $pdf->Cell(20, 5, $pagRecMedEste, 1, 3, 'L', false);
    $pdf->SetY($posy + 55);
    $pdf->SetX(2);
    $pdf->Cell(49, 5, utf8_decode("PAGO RECONEXIONES NO MEDIDAS"), 1, 3, 'L', false);
    $b                         = new Pago();
    $total += $pagRecNoMedEste = $b->getCantRecPagByPerTipGerPro($periodo, 'N', 'E', $proyecto,$contratista);
    $pdf->SetY($posy + 55);
    $pdf->SetX(51);
    ...
    $pdf->SetY($posy + 65);
    $pdf->SetX(51);
    $total += $corEfecNoMeEste = $b->getValRecByPerTipGerPro($periodo, 'S', 'E', $proyecto,$contratista);
    ...
    $b                       = new Pago();
    $total += $corEfecMeEste = $b->getValRecByPerTipGerPro($periodo, 'N', 'E', $proyecto,$contratista);
    $pdf->SetY($posy + 70);
    $pdf->SetX(51);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $pdf->Cell(49, 5, utf8_decode("CORTE EFECTIVO NO MEDIDOS"), 1, 3, 'L', false);
    $b                        = new Corte();
    $total += $corEfecMeNorte = $b->getCantGerTipo($periodo, 'N', 'N', $proyecto,$contratista);
    $pdf->SetY($posy + 40);
    $pdf->SetX(51 + 110);
    ...
    $pdf->SetY($posy + 50);
    $pdf->SetX(51 + 110);
    $total += $pagRecMedNor = $b->getCantRecPagByPerTipGerPro($periodo, 'S', 'N', $proyecto,$contratista);
    $pdf->Cell(20, 5, $pagRecMedNor, 1, 3, 'L', false);
    $pdf->SetY($posy + 55);
    $pdf->SetX(2 + 110);
    $pdf->Cell(49, 5, utf8_decode("PAGO RECONEXIONES NO MEDIDAS"), 1, 3, 'L', false);
    $b                        = new Pago();
    $total += $pagRecNoMedNor = $b->getCantRecPagByPerTipGerPro($periodo, 'N', 'N', $proyecto,$contratista);
    $pdf->SetY($posy + 55);
    $pdf->SetX(51 + 110);
    ...
    $pdf->SetY($posy + 65);
    $pdf->SetX(51 + 110);
    $total += $corEfecNoMeEste = $b->getValRecByPerTipGerPro($periodo, 'S', 'N', $proyecto,$contratista);
    $pdf->Cell(20, 5, "RD" . money_format('%.2n', $corEfecNoMeEste), 1, 3, 'L', false);
    $pdf->SetY($posy + 70);
    $pdf->SetX(2 + 110);
    $pdf->Cell(49, 5, utf8_decode("MONTO RECONEXIONES NO MEDIDAS"), 1, 3, 'L', false);
    $b                       = new Pago();
    $total += $corEfecMeEste = $b->getValRecByPerTipGerPro($periodo, 'N', 'N', $proyecto,$contratista);
    $pdf->SetY($posy + 70);
    $pdf->SetX(51 + 110);
    $pdf->Cell(20, 5, "RD" . money_format('%.2n', $corEfecMeEste), 1, 3, 'L', false);
    $pdf->SetY($posy + 65);
