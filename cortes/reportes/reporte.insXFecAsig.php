...
$datos = $a->getInsXFecAsig($procIni, $procFin,$pro,$contratista);
    $objPHPExcel = new PHPExcel();
    $objPHPExcel->
        getProperties()
        ->setCreator("AceaSoft")
        ->setLastModifiedBy("AceaSoft")
        ->setTitle(utf8_encode("Inpecciones por fecha asignacion ") . $proyecto)
        ->setSubject("")
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ->setCellValue('A1', 'INSPECCIONES POR FECHA DE ASIGNACION')
    ...
    $objPHPExcel->getActiveSheet()->setTitle('Inspecciones X fecha asignacion');
    $objPHPExcel->setActiveSheetIndex(0);

    $objWriter = new PHPExcel_Writer_Excel2007($objPHPExcel);
    $nomarch   = "../../temp/insXFechaAsig" . time() . ".xlsx";
