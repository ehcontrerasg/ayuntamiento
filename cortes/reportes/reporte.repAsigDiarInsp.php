...
$stid     = $a->getUsrAsignadoAsignadorInspByFecha($fecha, $proyecto, $gerencia,$contratista);
$contPy   = 48;
$asiviejo = "";
while (oci_fetch($stid)) {
    ...
    $contPy += 4;
    $pdf->SetTextColor(0, 0, 0);
    $stid2 = $b->getCantInspGroupSecRutByFecAsig($fecha, $idAsignado, $idAsignador, $proyecto, $gerencia,$contratista);
    $pdf->Text(151, $contPy, utf8_decode($total));
...
$b = new Corte();
$pdf->SetTextColor(0, 0, 0);
$stid2   = $b->getInspAsigGroupSectorByFech($fecha, $proyecto, $gerencia,$contratista);
$contPy1 = 48;
$total   = 0;
while (oci_fetch($stid2)) {
    $sector = oci_result($stid2, 'ID_SECTOR');
...
$b = new Corte();
$pdf->SetTextColor(0, 0, 0);
$stid2  = $b->getInspAsigGroupMedByFech($fecha, $proyecto, $gerencia,$contratista);
$contPy = 48;
$total  = 0;
while (oci_fetch($stid2)) {
...
$nomarch = "../../temp/repinspdiar" . time() . ".pdf";
