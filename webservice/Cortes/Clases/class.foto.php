...
class FotosFacturaClass extends ConexionClass {
    ...
    { 
                $sql="INSERT INTO SGC_TT_FOTOS_CORTE (CONSECUTIVO,ID_INMUEBLE,FECHA,NOMBRE_FOTO,URL_FOTO,ID_PERIODO,ID_PROYECTO) VALUES ('$this->consecutivo',
        		'$this->codsistema',TO_DATE('$this->fecha','MM/DD/YYYY'),'$this->nombrefoto','$this->urlfoto',
        		'$this->periodo','$this->proyecto')";

        $resultado = oci_parse($this->_db,"INSERT INTO SGC_TT_FOTOS_CORTE (CONSECUTIVO,ID_INMUEBLE,FECHA,NOMBRE_FOTO,URL_FOTO,ID_PERIODO,ID_PROYECTO) VALUES ('$this->consecutivo',
        		'$this->codsistema',TO_DATE('$this->fecha','MM/DD/YYYY'),'$this->nombrefoto','$this->urlfoto',
        		'$this->periodo','$this->proyecto') ");
    ...
    public function existefoto($consecutivo,$codsistema,$nombrefoto)
    {
    	...
    	$resultado = oci_parse($this->_db,"SELECT COUNT(1) NUMFOTOS FROM SGC_TT_FOTOS_CORTE WHERE CONSECUTIVO='$consecutivo' AND ID_INMUEBLE='$codsistema'AND 
    ...
    public function cambiaEstadoFoto($idInmueble)
    {
        ...
        $sql = "BEGIN SGC_P_BORRAR_FOTOS_CORTE ($idInmueble,:PMSGRESULT,:PCODRESULT);COMMIT;END;";
        /* echo $sql;*/
