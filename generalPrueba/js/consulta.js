...
function popUpEstCuenta(){
    $("#linkImpEstCuenta").attr("href", "../../facturacion/datos/datos.RepEstCuen.php?tip=rep&inmueble="+codCol);
    $("#linkImpEstConcepto").attr("href", "../../facturacion/datos/datos.RepEstCon.php?tip=rep&inmueble="+codCol);
}


function actdatos(cliente,inm){

    window.open("../../catastro/vistas/vista.actualizarcliente.php?cod_cliente="+cliente+"&inm="+inm, '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=400,height=400');
}
...
function llenarDatInmGen()
{
    ...
    ({
        ...
        success : function(json) {
            ...
            $("#LegDetConDatInmCod").text($("#LegDetConDatInmCod").text()+' '+codCol);
            ...
            $("#inpDetConDatInmCon").val(json[0]['ID_CONTRATO']);
            ...
            $('#butActDat').click(
                function(){
                    actdatos($("#inpDetConDatInmCli").val(),codCol);
                }
            );
