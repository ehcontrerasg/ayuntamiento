...
<head>
    <meta  charset="UTF-8" />
    <title>Consulta GENERAL PRUEBA</title>
    <!-- alertas -->
    ...
    <script type="text/javascript" src="../js/tabber.js?83"></script>
    <link href="../../css/general.css?6" rel="stylesheet" type="text/css" />
     ...
     <article>
         ...
         <div class="contenedor-flexy" id="detConDatInm" >
             <fieldset id="fieldInfo" class="fieldset" >
                 <legend class="legend_fact" id="LegDetConDatInmCod"><b>Inmueble prueba N&deg;: </b></legend>
                 <div id="detContent">
                     <div class="divinfo">
                         <label>Zona:</label>
         ...
         <div class="contenedor-flexy" >
             <div class="tabber" id="tab">
                 ...
                 <div class="tabbertab" title="Fotos">
                     <div class="flexigrid" >
                         <div id="fotosConsGen" style="display: block;float: left">
