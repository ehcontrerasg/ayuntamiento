...
if ($verificarPermisos==true): ?>
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        <h3 class="panel-heading" style=" background-color:#A349A3; color:#FFFFFF; font-size:18px; width:1120px" align="center">Administrar Calles</h3>
        <div style="text-align:center; width:1120px;">
            <form name="FMTarifas" action="vista.adminurba.php" method="post" onsubmit="return rend();">
                <div class="flexigrid" style="width:100%">
                    <div class="mDiv">
                        <div align="left"><b>Administraci&oacute;n de Calles</b></div>
                    </div>
                </div>
            </form>
            <div class="flexigrid" style="width:100%">
                ...
                <div>
                    <table id="flex1" style="display:block;">
                        ...
                        <tr>
                            ...
                            <th align="center" class="th" style="width:255px">Nombre Calle</th>
                            <th align="center" class="th" style="width:80px">Tipo V&iacute;a</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr >
                            ...
                            <td class="tda" style="width:80px; text-align:center"><?php echo $id_via?></td>
                            <td class="tda" style="width:255px; text-align:center">
                                <div style="padding:0px" align="center" id="desc_nom_via<?php echo $id_via?>">
                                    <input class="input" type="text"  id="desc_nom_via <?php echo $id_via?>" name="desc_nom_via <?php echo $id_via?>" value="<?php echo $des_via?>" size="33">
                                </div>
                            </td>
                            <td class="tda" style="width:80px; text-align:center"><?php echo $tip_via?></td>
                        </tr>
                        <?php
                        }
                        ?>
            ...
            <script type="text/javascript">
                ...
                $("#flex1").flexigrid	({
                    ...
                    buttons: [
                        {name:'Agregar Calle', bclass:'add', onpress: test},
                        {separator: true}
                    ...
                    //sortorder: "ASC",
                    //usepager: true,
                    title: '<?php echo '<div align="left" style="margin-left:-7px; height:20px; margin-top:-4px">Listado de Calles</div>';?>',
                    //useRp: true,
                    //rp: 100,
                    //page: 1,
                ...
                function agregacalle() { // Traer la fila seleccionada
                    popup("vista.agregavia.php",770,610,'yes');
                }
