...
if ($verificarPermisos==true): ?>
    ...
    header("Content-Disposition: attachment; filename=Reporte_Contratos_Sectores_del_'$secini'_al_'$secfin'.xls");
    ...
    <table id="Exportar_a_Excel" class="scroll" border="1" bordercolor="#CCCCCC" style="height:300px">
        ...
        <tr>
            ...
            <th style="border:none; border-right:1px solid #DEDEDE; text-align:center; background-color:#A349A3; color:#FFFFFF">FECHA INICIO</th>
        </tr>
        </thead>
        <tbody>
        <?php
