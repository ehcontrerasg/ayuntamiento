...
//recibimos variables via get
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../flexigrid/style_facturacion.css" />
    ...
    <form name="FormDetalle" action="vista.detalle_consulta.php" method="get">
        ...
        <script type="text/javascript">
            ...
            &numfac=<?php echo $numfac;?>&tipofac=<?php echo $tipofac;?>&fecinipag=<?php echo $fecinipag;?>&fecfinpag=<?php echo $fecfinpag;?>',
        ...
        <iframe id="datosinmueble" style="display:block;float:left;border:solid;border-width:1px;border-color:#CCCCCC; width:1350px; height:380px" src="vista.datos_inmueble.php">
        </iframe>
    </form>
    </body>
    </html>
