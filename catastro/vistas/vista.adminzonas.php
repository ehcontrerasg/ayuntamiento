...
if ($verificarPermisos==true): ?>
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        <h3 class="panel-heading" style=" background-color:#A349A3; color:#FFFFFF; font-size:18px; width:1120px" align="center">Administrar Zonas</h3>
        <div style="text-align:center; width:1120px;">
            <form name="FMTarifas" action="vista.adminzonas.php" method="post" onsubmit="return rend();">
                <div class="flexigrid" style="width:100%">
                    <div class="mDiv">
                        <div align="left"><b>Administraci&oacute;n de Zonas</b></div>
                    </div>
                </div>
            </form>
            <div class="flexigrid" style="width:100%">
                ...
                <div>
                    <table id="flex1" style="display:block;">
                        ...
                        <tr>
                            ...
                            <th align="center" class="th" style="width:80px">Zona</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr >
                            ...
                            $registros=$l->obtenerzonas();
                            while (oci_fetch($registros)) {
                            $cont++;
                            $id_zona = oci_result($registros, 'ID_ZONA');
                            $id_proyecto = oci_result($registros, 'ID_PROYECTO');
                            ?>
                            <td class="tda" style="width:35px; text-align:center"><b><?php echo $cont?></b></td>
                            <td class="tda" style="width:80px; text-align:center"><?php echo $id_proyecto?></td>
                            <td class="tda" style="width:80px; text-align:center"><?php echo $id_zona?></td>
                        </tr>
                        <?php
                        }
                        ?>
            ...
            <script type="text/javascript">
                ...
                $("#flex1").flexigrid	({
                    ...
                    buttons: [
                        {name:'Agregar Zona', bclass:'add', onpress: test},
                        {separator: true}
                    ...
                    //sortorder: "ASC",
                    //usepager: true,
                    title: '<?php echo '<div align="left" style="margin-left:-7px; height:20px; margin-top:-4px">Listado de Zonas</div>';?>',
                    //useRp: true,
                    //rp: 100,
                    //page: 1,
                ...
                $(document).ready(function(){
                    $('input').blur(function(){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../datos/datos.adminzonas.php",
                            data: dataString,
                ...
                function agregazona() { // Traer la fila seleccionada
                    popup("vista.agregazona.php",770,610,'yes');
                }
