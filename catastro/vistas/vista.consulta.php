...
//pasamos variables por post
    ...
    <head>
        ...
        <link href="../../acordion/style_cat.css" rel="stylesheet" />
    ...
    if (isset($_REQUEST["buscar"])){
        ...
        <script type="text/javascript">
            ...
            &tipofac=<?php echo $tipofac;?>&fecinipag=<?php echo $fecinipag;?>&fecfinpag=<?php echo $fecfinpag;?>',	'<?php echo $codinmueble;?>','width=1350, height=660, replace=true');
        </script>
        <?php
    }
    ?>
    <div id="content" style="margin-top:-25px">
        <form name="consulta" action="vista.consulta.php" method="post" autocomplete="on">
            <h3 class="panel-heading" style="background-color:#A349A3; color:#FFFFFF; font-size:18px; width:1120px" align="center">Consulta General de Inmuebles</h3>
            <div style="text-align:center">
                <table width="100%">
                    <tr>
                        <td align="left" style="font-size:13px"><b>Filtros de B&uacute;squeda</b></td>
                        <td align="right">
                            <button type="submit" name="buscar" id="buscar" style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#A349A3; color:#A349A3" class="btn btn btn-INFO">
                ...
                <ul id="accordion" class="accordion">
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <table width="100%">
                                <tr>
                                    <td width="18%" align="left" style="font-size:11px" ><b>Urbanizaci&oacute;n</b><br />
                                        <input type="text" id="urbaniza" name="urbaniza" value="<? echo $urbaniza?>" class="btn btn-default btn-sm dropdown-toggle">
                                    </td>
                                    <td width="19%" align="left" style="font-size:11px" ><b>Tipo V&iacute;a</b><br />
                                    ...
                                    <td width="19%" align="left" style="font-size:11px" ><b>Nombre V&iacute;a</b><br />
