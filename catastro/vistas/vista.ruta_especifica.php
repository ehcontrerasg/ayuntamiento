...
<form action="acea_google.php"  name="formulario" method="post" >
 ...
 $sql="SELECT * FROM (
 SELECT LONGITUD, LATITUD, ID_INMUEBLE 
 FROM SGC_TT_ASIGNACION 
 WHERE ID_INMUEBLE IN ($cod_inms)  AND FECHA_FIN IS NOT NULL  AND ID_PERIODO=$id_periodo AND LONGITUD IS NOT NULL AND LONGITUD <> '(sin_datos)' 
...
// ECHO $sql;
 ...
 $sql="SELECT LONGITUD, LATITUD, ID_INMUEBLE 
 FROM SGC_TT_ASIGNACION 
 WHERE ID_INMUEBLE IN ($cod_inms) AND FECHA_FIN IS NOT NULL AND ID_PERIODO=$id_periodo 
...
FROM SGC_TT_ASIGNACION 
WHERE ID_INMUEBLE IN ($cod_inms)  AND ID_PERIODO=$id_periodo AND FECHA_FIN IS NOT NULL  AND LONGITUD IS NOT NULL AND LONGITUD <> '(sin_datos)' 
ORDER BY FECHA_FIN ASC";
// ECHO $sql;
 $stid = oci_parse($link, $sql);
 oci_execute($stid, OCI_DEFAULT);
