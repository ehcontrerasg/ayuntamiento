...
//pasamos variables por post
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        ...
        ?>
        <h3 class="panel-heading" style=" background-color:#A349A3; color:#FFFFFF; font-size:18px; width:760px" align="center">Resoluci&oacute;n de PQRs</h3>
                            ...
                            <tr>
                                ...
                                <td width="248" colspan="1">
                                    ...
                                    <select name='area_res' id="area_res" class='input' required>
                                        ...
                                        <?php
                                        $c = new PQRs();
                                        //$resultado = $c->seleccionaDepartamento ($area_user);
