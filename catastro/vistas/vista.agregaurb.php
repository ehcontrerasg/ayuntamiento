...
if ($verificarPermisos==true): ?>
    ...
    if (isset($_REQUEST['Agregar']))
    {
        ...
        $l= new Urbanizacion();
        $l->setdesc_urbanizacion($urbanizacion);
        $l->setidproyecto($SProyecto);
        $bandera=$l->NuevaUrbanizacion();
        if(bandera==0){
            echo "
		<script type='text/javascript'>
		if(confirm('Has creado la urbanizacion $urbanizacion')){
			window.close();
		}else{
		window.close();
		}
            ...
            echo "
		<script type='text/javascript'>
		if(confirm('ERROR al crear la urbanizacion $urbanizacion')){
			window.close();
		}else{
		window.close();
		}
    ...
    <body>
    <p>
        <form  id='formulariocli' action="vista.agregaurb.php" autocomplete="on" method="post" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-primary" style="border-color:rgb(163,73,163)">
                <h3 class="panel-heading" style="background-color:rgb(163,73,163);border-color:rgb(163,73,163)"><center>Agregar Urbanizaci&oacute;n</center> </h3>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="text-align:left">
                        ...
                        <div>
                            <span class="input-group-addon" style="font-size:12px">Urbanizaci&oacute;n</span>
                            <span class="input-group-addon">
								<?php echo "<input size='300' style='text-transform:uppercase';  id='urbanizacion'  required type='text'name='urbanizacion'  class='form-control' value='$urbanizacion' placeholder='Urbanizacion' width='14' height='10'>";?>
							</span>
                        </div>
