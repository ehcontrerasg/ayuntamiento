...
if ($verificarPermisos==true): ?>
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        <h3 class="panel-heading" style=" background-color:#A349A3; color:#FFFFFF; font-size:18px; width:1120px" align="center">Administrar Ciclos</h3>
        <div style="text-align:center; width:1120px;">
            <form name="FMTarifas" action="vista.adminciclos.php" method="post" onsubmit="return rend();">
                <div class="flexigrid" style="width:100%">
                    <div class="mDiv">
                        <div align="left"><b>Administraci&oacute;n de Ciclos</b></div>
                    </div>
                </div>
            </form>
            <div class="flexigrid" style="width:100%">
                ...
                <div>
                    <table id="flex1" style="display:block;">
                        ...
                        <tr >
                            ...
                            $registros=$l->obtenerciclos();
                            while (oci_fetch($registros)) {
                            $cont++;
                            $id_ciclo = oci_result($registros, 'ID_CICLO');
                            $des_ciclo = oci_result($registros, 'DESC_CICLO');
                            ?>
                            <td class="tda" style="width:35px; text-align:center"><b><?php echo $cont?></b></td>
                            <td class="tda" style="width:80px; text-align:center"><?php echo $id_ciclo?></td>
                            <td class="tda" style="width:255px; text-align:center">
                                <div style="padding:0px" align="center" id="desc_ciclo<?php echo $id_ciclo?>">
                                    <input class="input" type="text"  id="desc_ciclo <?php echo $id_ciclo?>" name="desc_ciclo <?php echo $id_ciclo?>" value="<?php echo $des_ciclo?>" size="33">
                                </div>
                            </td>
                        </tr>
                        <?php
            ...
            <script type="text/javascript">
                ...
                $("#flex1").flexigrid	({
                    ...
                    buttons: [
                        {name:'Agregar Ciclo', bclass:'add', onpress: test},
                        {separator: true}
                    ...
                    //sortorder: "ASC",
                    //usepager: true,
                    title: '<?php echo '<div align="left" style="margin-left:-7px; height:20px; margin-top:-4px">Listado de Ciclos</div>';?>',
                    //useRp: true,
                    //rp: 100,
                    //page: 1,
                ...
                $(document).ready(function(){
                    $('input').blur(function(){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../datos/datos.adminciclos.php",
                            data: dataString,
                ...
                function agregaciclo() { // Traer la fila seleccionada
                    popup("vista.agregaciclo.php",770,610,'yes');
                }
