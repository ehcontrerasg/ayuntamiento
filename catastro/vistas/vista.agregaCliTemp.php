...
if ($verificarPermisos==true): ?>
    ...
    <head>
        <html lang="es">
        <meta  charset=UTF-8" />
        <title>Agregar Cliente Temporal</title>
        <!-- alertas -->
        ...
        <!--logica pag    -->
        <script type="text/javascript" src="../js/ingCliTemp.js?<?php echo time(); ?>"></script>
    ...
    <section>
        <article>
            ...
            <span class="datoForm">
            <span class="titDato">Codigo Inmueble</span>
            <span class="inpDatp"><input id="inpAgrCliTemInm" type="number"></span>
        </span>

            <span class="datoForm">
            <span class="titDato">Nombre Cliente</span>
            <span class="inpDatp"><input id="inpAgrCliTemNomCli" type="text"></span>
        </span>

            <span class="datoForm">
            <span class="titDato">Tipo Documento</span>
            <span class="inpDatp"><select id="selAgrCliTemTipDoc"></select></span>
        </span>

            <span class="datoForm">
            <span class="titDato">Documento</span>
            <span class="inpDatp"><input id="inpAgrCliTemDoc" type="number"></span>
        </span>
            <button class="botonFormulario" id="butAgrCliTemAgr">agregar</button>
        </article>
    </section>
