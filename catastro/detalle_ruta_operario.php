...
<body>
<form name="rendimiento" action="detalle_ruta_operario.php" method="post" onsubmit="return rend();">
...
<!--
  ...
  $("#flex1").flexigrid (
    {
            url: 'datos_detalle_ruta.php?ruta=<?php echo $ruta; ?>&periodoI=<?php echo $periodo_ini; ?>&periodoF=<?php echo $periodo_fin; ?>&operario=<?php echo $cod_operario; ?>',
            dataType: 'json',
            colModel : [
