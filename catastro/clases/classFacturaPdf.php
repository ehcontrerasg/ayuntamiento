...
if($factura != ''){
	...
	$pdf->Text(10,15,'C�digo Sistema');
	$pdf->SetFont('Arial','B',16);
	$pdf->Text(10,25,$codinm);
	$pdf->SetFont('Arial','B',10);
	$pdf->Text(150,15,'NCF '.$ncffac);
	$pdf->Text(150,20,'C�digo de Inmueble');
	...
	$pdf->Cell(4,7,'',0,0,'C');
	$pdf->SetFont('Arial','B',8);
	$pdf->Cell(28,5,'Factura N�mero:',0,0,'L');
	$pdf->SetFont('Arial','',9);
	...
	$pdf->Cell(4,7,'',0,0,'C');
	$pdf->SetFont('Arial','B',8);
	$pdf->Cell(28,5,'Fecha de Emisi�n:',0,0,'L');
	$pdf->SetFont('Arial','',9);
	...
	$pdf->SetFont('Arial','B',8);
	$pdf->Text(111,255,'Factura N�mero:');
	$pdf->Text(111,259,'Periodo:');
	$pdf->Text(111,263,'C�digo Inmueble:');
	$pdf->Text(111,267,'C�digo Proceso:');
	$pdf->Text(154,255,'Fecha de Exp:');
	$pdf->Text(154,259,'C�digo Sistema:');
