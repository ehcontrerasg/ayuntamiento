<?php	
	...
	while (oci_fetch($stid)) {
		...
		$sql2 = "SELECT M.DESC_MENU, M.URL FROM SGC_TP_MENUS M, SGC_TP_PERFILES P  
		WHERE URL IS NOT NULL AND M.ID_MENU = P.ID_MENU AND ID_PADRE = $cod_menu AND P.ID_USUARIO = '$coduser'";
