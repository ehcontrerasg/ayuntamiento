...
<title>Reporte Planificaci&Oacute;n Toma de Lecturas</title>
</head>
<body>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td width="65%">
				<font size="26px" style="font-family:'."Times New Roman".', Times, serif">&nbsp;&nbsp;&nbsp;&nbsp;PLANIFICACI&Oacute;N TOMA DE LECTURAS</font>
			</td>
		</tr>
		<tr>
	...
	<tbody>	';
		$c=new Reportes_Plan_Lec();
			...
			while (oci_fetch($registros)) {
				...
				$asignador = oci_result($registros, 'USR_ASIGNADOR');
			...
			<td align="left" style="background-color:#990000; color:#FFFFFF;" >
				<b><font size="13px" style="font-family:'."Times New Roman".', Times, serif">Total lecturas</font></b>
			</td>
