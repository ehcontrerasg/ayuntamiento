...
<div id="content" style="padding:0px; width:1120px; margin-left:20px">
    <form name="FMCorMora" action="vista.corre_mora.php" autocomplete="on" method="post">
        <h3 class="panel-heading" style=" background-color:#336699; color:#FFFFFF; font-size:18px; width:1120px" align="center">Proceso de Mora</h3>
...
if (isset($_REQUEST["Procesar"])){
    ...
    <script type='text/javascript'>
     desabilita();
	    ...
	    $i = new facturas();
                $result = $i->corremora($zona,$periodo);
