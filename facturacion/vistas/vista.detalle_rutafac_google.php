...
<form action="acea_google.php"  name="formulario" method="post" >
  ...
  $registros=$l->obtenerpripunto($cod_ruta, $fechaini, $fechafin, $operario);
 ...
 //traemos ultimo punto leido con coordenadas
  $l=new coordenadasfac();
  $registros=$l->obtenerultpunto($cod_ruta, $fechaini, $fechafin, $operario);
  while (oci_fetch($registros)) {
 	$xi = oci_result($registros, 'LONGITUD');
   	$yi = oci_result($registros, 'LATITUD');	
 ...
 $l=new coordenadasfac();
 $registros=$l->obtenerrestpunto($cod_ruta, $fechaini, $fechafin, $operario,$id_sistema_ini,$id_sistema_fin);
 $i=0;
 while (oci_fetch($registros)) {
 	$i=$i+1;
...
$array_coordenadas = "";
 $l=new coordenadasfac();
 $registros=$l->obtenertodtpunto($cod_ruta, $fechaini, $fechafin, $operario);
 while (oci_fetch($registros)) {
  	$x = oci_result($registros, 'LONGITUD');
    $y = oci_result($registros, 'LATITUD');
    $array_y =  "$y";
