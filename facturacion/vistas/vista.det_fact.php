    ...
    <script type="text/javascript">
        ...
        $("#flex1").flexigrid	(
        {
            ...
            colModel : [
                ...
                {display: 'Concepto', name: 'CONCEPTO', width: 65, sortable: true, align: 'center'},
                {display: 'Rango', name: 'RANGO', width: 40, sortable: true, align: 'center'},
                {display: 'Unidades', name: 'UNIDADES', width: 50, sortable: true, align: 'center'},
				{display: 'Precio', name: 'PRECIO', width: 50, sortable: true, align: 'center'},
                {display: 'Valor', name: 'VALOR', width: 200, sortable: true, align: 'center'}
            ],
