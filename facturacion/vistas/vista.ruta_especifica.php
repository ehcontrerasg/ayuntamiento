...
<form action="acea_google.php"  name="formulario" method="post" >
 ...
 FROM SGC_TT_registro_entrega_fac rf
 WHERE RF.COD_INMUEBLE IN ($cod_inms)  AND RF.FECHA_EJECUCION between to_date('$fecini','ddmmyyyyhh24miss')  and to_date('$fecfin','ddmmyyyyhh24miss') 
