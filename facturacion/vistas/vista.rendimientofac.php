...
?>
	...
	<h3 class="panel-heading" style=" background-color:#336699; color:#FFFFFF; font-size:18px; width:1120px" align="center">Rendimiento de Facturas por fecha asignacion</h3>
    		...
    		<tr>
			    ...
			    <td align="left" width="15%" bgcolor="#EBEBEB">
					<select id="periodo" name='periodo' class='btn btn-default btn-sm dropdown-toggle' onChange='recarga();'>
						...
						<?php
	                    $sql = "SELECT PERIODO 
						FROM SGC_TT_REGISTRO_ENTREGA_FAC L, SGC_TP_ZONAS Z
				...
				<td align="left" width="15%" bgcolor="#EBEBEB">
					<select name='sector' id='sector' class='btn btn-default btn-sm dropdown-toggle' onChange='recarga();'>
						...
						FROM SGC_TT_REGISTRO_ENTREGA_FAC L, SGC_TP_SECTORES S 
