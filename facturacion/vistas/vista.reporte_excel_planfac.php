...
header("Content-Disposition: attachment; filename=Planificacion_Entrega_Facturas_".$proyecto."_Periodo_".$perini."".$nomrepo.".xls");
	...
	<table class="scroll" border="1" bordercolor="#CCCCCC" style="height:350px">
		...
		<?php
			...
			while (oci_fetch($registros)) {
				...
				$fecpla = oci_result($registros, 'FECHA_PLANIFICACION');
				$h=new Reportes_Plan_Fac();
				$registrosC=$h->ObtieneDetalleRutas($cod_lector, $zona, $perini,$fecpla);
