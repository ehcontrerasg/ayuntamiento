...
<table id="Exportar_a_Excel" style="display:none">
    <tr>
        ...
        <th align="center">FECHA LECTURA</th>
...
<!--
  ...
  $("#flex1").flexigrid (
    {
            url: '../datos/datos_detalle_rutalec.php?fecini=<?php echo $fechaini;?>&fecfin=<?php echo $fechafin;?>&operario=<?php echo $operario;?>&ruta=<?php echo $cod_ruta;?> ',
            dataType: 'json',
            colModel : [
                {display: 'No', name: 'numero', width: 20, sortable: true, align: 'center'},
                {display: 'Cod Sistema', name: 'codigo_inm', width: 57, sortable: true, align: 'center'},
                {display: 'Id Proceso', name: 'id_proceso', width: 62, sortable: true, align: 'center'},
                {display: 'Direcci&oacute;n', name: 'direccion', width: 122, sortable: true, align: 'center'},
                {display: 'Lectura', name: 'Lectura', width: 34, sortable: true, align: 'center'},
                {display: 'Observacion', name: 'obs', width: 61, sortable: true, align: 'center'},
                {display: 'Consumo', name: 'cons', width: 61, sortable: true, align: 'center'},
                {display: 'Fecha Lectura', name: 'fecha_mant', width: 97, sortable: true, align: 'center'},
                {display: 'Fotos', name: 'foto', width: 37, sortable: true, align: 'center'},
                {display: 'Ubicaci&oacute;n', name: 'ubicacion', width: 43, sortable: true, align: 'center'}
                ],  
  ...
  function fotos(id2,fecha,id4) { // Traer la fila seleccionada
      popup("vista.fotos_lec.php?cod_sistema="+id2+"&fechaini="+fecha+"&fechafin="+id4,1100,800,'yes','pop1');
  }           
...
//-->    
  function agrega(codigos_inm) { // Traer la fila seleccionada
	  window.open("/acea/facturacion/vistas/vista.ruta_especificalec.php?inmueble="+codigos_inm+"&fecini=<?php echo $fechaini ?>"+"&fecfin=<?php echo $fechafin?>"+"&operario=<?php echo $operario?>" , "ventana1" , "width=770,height=6600,scrollbars=yes") 
  }
