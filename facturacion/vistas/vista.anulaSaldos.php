...
if ($verificarPermisos==true): ?>
    ...
    <?php
    session_start();
    require'../../clases/class.saldoFavor.php';
    require'../../clases/class.inmueble.php';
...
//pasamos variables por post
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        <?php
        $c = new Inmueble();
        $resultado = $c->GetDatInmByCod($cod_inmueble);
        while (oci_fetch($resultado)) {
            $cod_inm = $cod_inmueble;
            ...
            $nom_cli = oci_result($resultado, 'NOMBRE');
            $cod_pro = oci_result($resultado, 'ID_PROYECTO');
            $des_pro = oci_result($resultado, 'ID_PROYECTO');
            $cliente = oci_result($resultado, 'NOMBRE');
        ...
        if (isset($_REQUEST["procesar"])){
            ...
            $d = new SaldoFavor();
            $bandera = $d->ReversaSaldos($cod_pago, $observacion, $coduser);
            if($bandera == false){
                ...
                <script>
                    swal({
                        title: "Error",
                        text: "No fue posible anular el saldo N&deg; <?php echo $cod_pago.'.<br>'?> Codigo: <?php echo $coderror.'.<br>'?> Error: <?php echo $error?>.",
                        type: "error",
        ...
        ?>
        <h3 class="panel-heading" style=" background-color:#336699; color:#FFFFFF; font-size:18px; width:1120px" align="center">Anulaci&oacute;n de Saldos</h3>
        <form name="anulapagos" action="vista.anulaSaldos.php" method="post">
            ...
            <div class="flexigrid" style="width:100%">
                ...
                <div style="display:none; float: left" id="divpagos">
                    <table id="saldFavFlexy" style="display:block;float: left">
                    </table>
                </div>
            </div>
        </form>
        <script type="text/javascript">
            ...
            $("#saldFavFlexy").flexigrid	(
                {

                    url: '../datos/datos.anulaSaldos.php?inmueble=<?php echo $cod_inmueble;?>',
        ...
        <iframe id="ifdetfacSaldos" style="border-left:0px solid #ccc; border-right:0px solid #ccc;" class="iframe"></iframe><br />
    </body>
    </html>
    <script type="text/javascript">
