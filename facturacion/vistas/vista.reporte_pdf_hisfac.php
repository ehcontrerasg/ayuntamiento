...
$pdf->SetAuthor('AceaSoft');
$pdf->SetTitle('Reporte Historico Facturacion');
$pdf->SetSubject('Reportes de facturacion');
$pdf->SetKeywords('Reporte, usuario, php, oracle');
...
$codigoHTML.='</table>
	...
	$pdf->writeHTMLCell($w=0, $h=0, $x='', $y='', $codigoHTML, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
...
$pdf->Output('ReporteFacturacion.pdf', 'I');
?>