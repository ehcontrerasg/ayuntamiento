...
<body style="margin-top:-25px" >
	<div id="content" style="padding:0px; width:470px; margin-left:0px; color:">
		<h3 class="panel-heading" style=" background-color:#336699; color:#FFFFFF; font-size:18px; width:470px; font-family:'Times New Roman', Times, serif" align="center">Crear Diferidos</h3>
	</div>
<?php
 ...
 <form name="formdif2" action="" method="get">
	<div style="display: block;float: left">
		...
		<table cellpadding="0" cellspacing="0" align="left" width="40%">
			<tr>
				<td>
					<fieldset class="fieldset_diferido" style="width:450px"> 
				...
				<td>	
					<fieldset class="fieldset_diferido" style="width:450px">
						...
						<table align="center" cellpadding="0" cellspacing="0" >
							...
							?>
							  	<td align="center">
									<button  <?php echo $disabled?> style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#336699; color:#336699" type="submit" name="procesar" 
