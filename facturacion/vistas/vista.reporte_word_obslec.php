...
header("Content-Disposition: attachment; filename=Reporte_Observaciones_Lectura_$proyecto_Periodo_$perini$nomrepo.doc");
...
<body>
 <?php
	...
	<table id="Exportar_a_Excel" class="scroll" border="1" bordercolor="#CCCCCC" style="height:300px">
    	<thead>
        	<tr>
				<th style="border:1px solid #DEDEDE; text-align:center; background-color:#336699; color:#FFFFFF" rowspan="2">N&deg;</th>
				<th style="border:1px solid #DEDEDE; text-align:center; background-color:#336699; color:#FFFFFF" rowspan="2">ZONA</th>
				<th style="border:1px solid #DEDEDE; text-align:center; background-color:#336699; color:#FFFFFF" rowspan="2">LECTOR</th>
				<th style="border:1px solid #DEDEDE; text-align:center; background-color:#336699; color:#FFFFFF" colspan="<?php echo $cantob;?>">OBSERVACIONES
				</th>
				<th style="border:1px solid #DEDEDE; text-align:center; background-color:#336699; color:#FFFFFF" rowspan="2">TOTALES</th>
            </tr>
        	<tr>
				<?php
				$c=new Reportes();
				...
				while (oci_fetch($registros)) {
					...
					echo "<th style='border:1px solid #DEDEDE; border-top:1px solid #DEDEDE; background-color:#336699; color:#FFFFFF'>$observacion</th>";
				} unset($observacion);
				oci_free_statement($registros);
				?>
      	  	</tr>
