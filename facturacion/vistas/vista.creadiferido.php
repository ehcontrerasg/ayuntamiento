...
//pasamos variables por post
    ...
    <div id="content">
        ...
        if($codinmueble != ""){
            ...
            ?>
            <form name="datinm" action="vista.creadiferido.php" method="get">
            ...
            <div class="tabber" id="tab" style="width:1070px;">
                <div class="tabbertab" title="Acuerdo de Pago">
                    <form name="formcompl_dif" action="vista.diferido.php" method="get">
                        <?php
                        include('vista.diferido.php');
                        ?>
                    </form>
                </div>
            </div>
