...
<head>
    ...
    <meta  charset="UTF-8" />
    <title>Relación Facturación</title>
    <!-- alertas -->
    ...
    <script type="text/javascript" src="../js/relFacturacion.js?<?php echo time();?>"></script>
    <link href="../../css/general.css " rel="stylesheet" type="text/css" />
</head>
<body>
<header class="cabeceraTit fondFac">
    Reporte Relación De Facturación
</header>
    ...
    <article>
        <form onSubmit="return false" id="repGenNotForm">
            <span class="datoForm col1">
                ...
                <span class="inpDatp numCont2"><input type="number" name="periodo" tabindex="1" id="repGenNotFecIni" required ></span>
                <span class="titDato numCont2">Inmueble:</span>
                <span class="inpDatp numCont2"><input type="number" name="inmueble" tabindex="1" id="repGenNotFecIni" required ></span>
