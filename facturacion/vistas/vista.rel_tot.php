...
if(isset($_REQUEST['procesar'])){
    $p=new reliquidacion();
	$result=$p->reltot($codinmueble,$obs,$coduser);
...
<div id="content" class="flexigrid" >
    <form  id="FMRelConc" name="FMRelConc" action="vista.rel_tot.php" method="post" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
