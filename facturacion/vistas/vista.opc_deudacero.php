...
<body>
	<ul id="accordion" class="accordion">
		<li>
			...
			<a href="vista.creadeudacero.php?codinmueble=<?php echo $codinmueble?>" target="jobFrame">Crear PDC</a></div>
		</li>
		<li>
			<div class="link"><i class="fa fa-download" style="color:#990000"></i>
			<a href="vista.reversadeudacero.php?codinmueble=<?php echo $codinmueble?>" target="jobFrame">Reversar PDC</a></div>
		</li>
		<li>
		</li>
	</ul>
