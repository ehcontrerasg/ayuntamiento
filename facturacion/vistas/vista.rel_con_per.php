...
if(isset($_REQUEST['procesar'])){
    ...
    for ($i=1;$i<=$contador;$i++) {
        $postcon = 'idcon' . $i;
        $postval = 'valdif' . $i;
        $concepto[$i] = $_POST[$postcon];
        $valor[$i] = $_POST[$postval];
        $result=$p->relconcepto($codinmueble,$concepto[$i],$perini,$perfin,$valor[$i],$tiponota,$coduser,$obs);
...
<div id="content" class="flexigrid" >
    ...
    <form  id="FMRelConc" name="FMRelConc" action="vista.rel_con_per.php" method="post">
        ...
        <?php
            ...
            <tr>
				...
				<th class="th"><b>Tipo de Nota:&nbsp;&nbsp;</b>
					<input type="radio" id="tiponota" name="tiponota" value="NOTA DEBITO" required> Debito
        			<input type="radio" id="tiponota" name="tiponota" value="NOTA CREDITO" required> Credito
				</th>
            </tr>
            <tr>
