...
<!--
  ...
  $("#flex1").flexigrid (
    {
            url: '../datos/datos_detalle_ruta_lecturas.php?cod_operario=<?php echo $cod_operario;?>&periodo=<?php echo $periodo;?>&cod_ruta=<?php echo $cod_ruta;?>&fecini=<?php echo $fecini;?>&fecfin=<?php echo $fecfin;?>',
            dataType: 'json',
            colModel : [
				...
				{display: 'Fecha Lectura', name: 'fecha_mant', width: 100, sortable: true, align: 'center'},
                {display: 'Lectura', name: 'Lectura', width: 35, sortable: true, align: 'center'},
                {display: 'Observaci&oacute;n', name: 'obs', width: 65, sortable: true, align: 'center'},
                {display: 'Consumo', name: 'cons', width: 60, sortable: true, align: 'center'},
...
//-->    
  function agrega(codigos_inm) { // Traer la fila seleccionada
	  window.open("vista.ruta_especificalec.php?inmueble="+codigos_inm+"&fecini=<?php echo $fecini ?>"+"&fecfin=<?php echo $fecfin?>"+"&cod_operario=<?php echo $cod_operario?>"+"&periodo=<?php echo $periodo?>" , "ventana1" , "width=1100,height=600,scrollbars=yes") 
  }
