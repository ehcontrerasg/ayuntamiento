...
//pasamos variables por post
    ...
    <div id="content" style="padding:0px">
        ...
        ?>
        <form name="asignalotlec" action="vista.asignacionlec.php" method="post" >
            <h3 class="panel-heading" style=" background-color:#336699; color:#FFFFFF; font-size:18px; width:1120px" align="center">Asignaci&oacute;n Lote Lecturas</h3>
            <div style="text-align:center; width:1120px; margin-left:0px">
                <table width="100%" border="1" bordercolor="#CCCCCC" align="center">
                    <tr>
                        ...
                        <td align="left" width="15%" bgcolor="#EBEBEB">
                        <td><input  type="date" name="fecPla" id="fecPla" required value="<? echo $fecPla?>" class="form-control" maxlength="10" size="10" /></td>
                        </td>
                    </tr>
                </table>
                <?php
                ...
                <table width="49%" border="1" bordercolor="#CCCCCC" align="left" vspace="12" >
                    ...
                    <tr>
                        ...
                        $cantlect = 0;
                        $c = new AsignaLotes();
                        $resultado = $c->seleccionaAsignacion($periodo, $zona);
                        while (oci_fetch($resultado)) {
                ...
                <table width="49%" border="1" bordercolor="#CCCCCC" align="right" vspace="12">
                    ...
                    <tr>
                        ...
                        $cantlectd = 0;
                        $c = new AsignaLotes();
                        $resultado = $c->seleccionaDesasignacion($periodo, $zona);
                        while (oci_fetch($resultado)) {
