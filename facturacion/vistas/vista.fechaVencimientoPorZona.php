...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <!--lógica de la página-->
        <script src="../js/fechaVencimientoPorZona.js?4"></script>
    </head>
    <header>
        <div class="cabecera">
            <h4 align="center">Fecha de Vencimiento de Facturas por Zona</h4>
        </div>
    </header>
    <body>
    <form onsubmit="return false"  id="frmFecVencPorZona" method="POST">
        <div class="row" style="background-color: #e1e3e8;">
            ...
            <div class="form-group col-sm-2" id="dvSector">
                <center>
                    <label>Zona:</label>
                    <input type="text" id="txtZona" name="zona" >
                </center>
            </div>
