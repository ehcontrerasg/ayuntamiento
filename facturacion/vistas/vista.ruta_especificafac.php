...
else $where = "AND RL.FECHA_EJECUCION BETWEEN TO_DATE('$fecini','yyyymmdd hh24:mi:ss')  AND TO_DATE('$fecfin','yyyymmdd hh24:mi:ss')"; 

 $sql="SELECT * FROM (
 SELECT LONGITUD, LATITUD,COD_INMUEBLE 
 FROM SGC_TT_REGISTRO_ENTREGA_FAC RL
