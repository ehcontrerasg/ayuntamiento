...
$periodoM=$_GET['periodo'];
$inmuebleM=$_GET['inmueble'];

$l= new facturas();
$stid= $l->ConsecFact($inmuebleM,$periodoM);
while (oci_fetch($stid)) {
    $factura = oci_result($stid, 'CONSEC_FACTURA');
}
...
if($factura != '') {
    ...
    $pdf->Text(91,98/*(95 - $posXDatosFactura), (95 - $posYDatosFactura)*/, $consumo);
    $pdf->SetFont('Arial', '', 9);
