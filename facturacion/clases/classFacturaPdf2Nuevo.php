...
if($factura != ''){
    ...
    //CABECERA FACTURA
        $posYCabecera=8; //Determina la posición de Y sumando o restando al valor actual
...
/*    $pdf->Cell(93,4,'SERVICIO                        USO                      TARIFA           UNIDADES',0,0,'R',true);*/
  ...
  /*  $pdf->Text(109,83,utf8_decode('Factura número:'));
   ...
   /* if($acueducto == 'SD')
    ...
    $pdf->SetFont('Arial','B',8);
    $pdf->Text(141,255,$factura);
    $pdf->Text(141,259,$mes."/".$agno);
    $pdf->Text(141,263,$catastro);
    $pdf->Text(141,267,$proceso);
    $pdf->Text(187,255,$fecexp);
    $pdf->Text(187,259,$codinm);
   ...
   /* $pdf->Text(33,259,'Estafeta:');
    ...
    $pdf->Text(145,289,utf8_decode($urbaniza),0,0,'C');

    $pdf->Text(30,286,$codinm);
    $pdf->SetFont('Arial','',9);
    ...
    $pdf->SetFont('Arial','B',9);
    $pdf->Text(183,276,'RD$ '.$totalfactura);
    /*$pdf->Rect(136,273,63,12);*/
    $pdf->SetFont('Arial','B',9);
    /*$pdf->Text(139,283,'Vencimiento:');*/
    $pdf->Text(180,282,$fecvcto);
