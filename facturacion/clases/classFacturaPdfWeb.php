            ...
            while (oci_fetch($stid)) {
                ...
                if ($concepto == 'Agua' || $concepto == 'Agua de Pozo') {
                    ...
                    if ($rango == 0) {
                        ...
                        if ($unidades > 0) {
                            if ($acueducto == 'SD') $valor_mts = round(($valor / $unidades), 2); /*Esta linea se modificará cuando Estiven solicite el cambio*/
                        ...
                        if ($unidades > 0)
                            $pdf->Cell(20, 5, $valor_mts, 0, 0, 'R');/*Esta linea se modificará cuando Estiven solicite el cambio*/
                        else
                ...
                if ($concepto == 'Alcantarillado Red' || $concepto == 'Alcantarillado Pozo') {
                    ...
                    if ($rango >= 0) {
                        ...
                        $pdf->Cell(10, 5, $unidades, 0, 0, 'R');
                        if ($unidades > 0)
                            $pdf->Cell(20, 5, round(($valor / $unidades), 1), 0, 0, 'R');/*Esta linea se modificará cuando Estiven solicite el cambio*/
                        else
                            $pdf->Cell(20, 5, 0, 0, 0, 'R');
                        $pdf->Cell(20, 5, $valor, 0, 0, 'R');
                        $totalservicios += $valor;
