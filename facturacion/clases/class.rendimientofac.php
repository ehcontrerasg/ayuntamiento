...
class Rendimiento extends ConexionClass{
	...
	{	
		...
		FROM SGC_TT_REGISTRO_ENTREGA_FAC L
		WHERE $where
		AND L.RUTA = '$cod_ruta'  
	...
	{	
        ...
        FROM SGC_TT_REGISTRO_ENTREGA_FAC L, SGC_TT_INMUEBLES I
	...
	public function existefotolec($codigo_inm,$cod_operario,$periodo,$fecini,$fecfin)
	{
		...
		$sql="SELECT COUNT(*) CANTIDAD FROM SGC_TT_FOTOS_FACTURA FL,SGC_TT_REGISTRO_ENTREGA_FAC RL
	...
	public function existecoordenadalec($codigo_inm,$periodo,$fecini,$fecfin,$cod_operario)
	{
		...
		$sql="SELECT COUNT(*) CANTIDAD FROM  SGC_TT_REGISTRO_ENTREGA_FAC RL
		WHERE
