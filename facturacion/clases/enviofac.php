...
$datos = $cliente->getDatosCliente($inmueble);
while (oci_fetch($datos)) {
    $email = oci_result($datos, 'EMAIL');
    $idpro = oci_result($datos, 'ID_PROYECTO');
    $nombre = oci_result($datos, 'NOMBRE_CLIENTE');
}
...
if ($idpro == 'SD') {
    ...
    <title>Envio De Factura Por Correo</title>
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
                               ...
                               <table cellspacing="0" cellpadding="0" style="border-collapse: collapse; margin: 24px 0 24px 0;">
                                   ...
                                   <tr>
                                       <td colspan="3" style="padding: 10px 10px 10px 10px" >
                                          ...
                                          Este es un duplicado de la factura solicitado en la oficina. <br />
                                       </td>
                                   </tr>
                               </table>
                            </td>
                        ...
                        <tr>
                            <td style="font-size: 12px; padding-top: 1em;" align="center">
                                Si no ha solicitado un duplicado de su factura por favor ignorar este correo.
                            </td>
                        </tr>
                    </table>
                </td>
...
//else $pdf->Image('../../images/logo_coraabo_2.png',11,5,75,20);
if ($acueducto == 'SD') {
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->Text(15, 36, utf8_decode('FECHA DE EMISION '), 0, 0, 'L');
$pdf->SetFont('Arial', 'B', 10);
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(35, 289, $codinm);
$pdf->Text(60, 290, utf8_decode($alias));
$pdf->Text(160, 289, utf8_decode($urbaniza), 0, 0, 'C');
...
$correo->enviarcorreo($email, $idpro, $asunto, $mensaje, $factura);
echo $mensaje;
