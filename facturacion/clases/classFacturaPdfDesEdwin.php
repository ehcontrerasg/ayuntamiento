...
//      $msjfactura=oci_result($stid, 'MSJ_FACTURA');
    ...
    if($acueducto == 'SD' && $periodo >= 202112){
        ...
        $pdf->Rect(103, 59, 77, 7, 'F');
        $pdf->Text(140,64,utf8_decode('DATOS DE MEDICIÓN') ,0,0,'C');
        $pdf->SetTextColor(18,48,108);
        $pdf->Text(12,70,utf8_decode('Concepto         | Cantidad | Precio | Importe') ,0,0,'C');
        $pdf->Text(106,70,'Lectura anterior');
        $pdf->Text(106,75,'Fecha lectura anterior');
        $pdf->Text(106,80,'Serial');
        $pdf->Text(106,85,'Calibre');
        $pdf->Text(106,90,utf8_decode('Tipo Cálculo'));
        $pdf->Text(146,70,'Lectura actual');
        $pdf->Text(146,75,'Fecha lectura actual');
        $pdf->Text(146,80,'Consumo facturado');
        $pdf->Text(146,85,'Marca');
        ...
        $pdf->Rect(103, 137, 77, 7, 'F');
        $pdf->Text(168,142,utf8_decode('AVISO') ,0,0,'C');

        $pdf->Rect(103, 197, 77, 7, 'F');
        ...
        $pdf->Text(7,258,utf8_decode('Nombre') ,0,0,'C');
        $pdf->Text(7,263,utf8_decode('Código de sistema') ,0,0,'C');
        $pdf->Text(7,267,utf8_decode('Código de proceso') ,0,0,'C');
        $pdf->Text(7,272,utf8_decode('Fecha de emisión') ,0,0,'C');
        $pdf->Text(7,277,utf8_decode('Factura No.') ,0,0,'C');
        $pdf->Text(7,281,utf8_decode('Periodo') ,0,0,'C');
        $pdf->Text(7,285,utf8_decode('Vencimiento') ,0,0,'C');
        $pdf->Text(7,294,utf8_decode('Sello y firma') ,0,0,'C');
