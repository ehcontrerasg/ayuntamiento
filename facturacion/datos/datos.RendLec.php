...
function countRec($fname,$tname,$where,$sort){
		$l=new Reportes();
		$valores=$l->CantidadRendLec($fname, $tname,$where,$sort);
...
$fname ="USR.LOGIN";
$tname="SGC_TT_USUARIOS USR, SGC_TT_INMUEBLES INM, SGC_TT_REGISTRO_LECTURAS LEC";
$where = " AND LEC.FECHA_LECTURA_ORI BETWEEN TO_DATE('$fecini 00:00:00', 'YYYY-MM-DD hh24:mi:ss') AND TO_DATE('$fecfin 23:59:59', 'YYYY-MM-DD hh24:mi:ss') and INM.ID_PROYECTO='$proyecto'";
//$fname = "USERNME";
//$tname = "SGC_TT_INMUEBLES I, SGC_TP_URBANIZACIONES U, SGC_TT_CLIENTES C, SGC_TP_ACTIVIDADES A, SGC_TT_ASIGNACION S";

if ($query)
{ $where = " AND AND LEC.FECHA_LECTURA_ORI BETWEEN TO_DATE('$fecini 00:00:00', 'YYYY-MM-DD hh24:mi:ss') AND TO_DATE('$fecfin 23:59:59', 'YYYY-MM-DD hh24:mi:ss') AND UPPER($qtype) LIKE UPPER('$query%') ";
}
$l=new Reportes();
$registros=$l->TodosRendLec($where, $sort, $start, $end);
