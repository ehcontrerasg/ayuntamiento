...
$c = new Reportes();
$stid = $c->seleccionaZonas($user_input2);
while (oci_fetch($stid)) {
	$json_arr["id"] = oci_result($stid, 'ID_SECTOR') ;
	$json_arr["value"] = oci_result($stid, 'ID_SECTOR');
	$json_arr["label"] =  oci_result($stid, 'ID_SECTOR');
