...
while (oci_fetch($registros)) {
    ...
    /*    Evaluar si el cliente del reclamo cuenta con cedula registrada en el sistema.
     *    Los clientes con cedula registrada tendran el numero de registro en color rojo.
     */

    $cedReg     = new PQRs();
    $evaluacion = $cedReg->cedExists($cod_inm);

    if ($evaluacion) {
        $num = "cell:['<b style=\"color:red;\">" . $numero . "</b>'";
    } else {
        $num = "cell:['<b>" . $numero . "</b>'";
    }
