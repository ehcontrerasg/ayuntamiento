...
function deuCerInicio()
{
    deuCerInpApo    = document.getElementById("deuCerInpApo");
    deuCerInpNumCuo = document.getElementById("deuCerInpNumCuo");
    deuCerInpValCuo = document.getElementById("deuCerInpValCuo");
    deuCerButPro    = document.getElementById("deuCerInpBut");

    deuCerInpApo.addEventListener('keyup',cambiaInp)
	deuCerInpNumCuo.addEventListener('keyup',cambiaCuo)
...
function cambiaInp(){
    ...
    if(deuCerInpApo.value==300){
        deuCerInpNumCuo.value=2;
		deuCerInpNumCuo.readOnly = false;
    }else{
        deuCerInpNumCuo.value=1;
		deuCerInpNumCuo.readOnly = true;
    }

    deuCerInpValCuo.value=deuCerInpApo.value/deuCerInpNumCuo.value;
