$(document).ready(function(){
   ...
   $('#dataTable').hide();
    ...
    function getReport()
    {
        //  e.preventDefault();
        // var data = e.target;
        //var fechaDesde = data.fechaDesde.value,
        //   fechaHasta = data.fechaHasta.value;



        var datos = $(form).serialize();
        $.get('../datos/datos.InmueblesActivos.php?tipo=report&'+datos, function(res) {
            ...
            $('#dataTable').DataTable( {
                ...
                columns: [{ title: "PROYECTO" },{ title: "USO" }, { title: "TOTAL" }


                ],

                buttons: [
                    { extend: 'copy',title:'Reporte Inmuebles Activos', text:' Copiar', className:'btn btn-primary glyphicon glyphicon-duplicate' },
                    { extend: 'csv', title:'Reporte Inmuebles Activos', text:' CVS', className: 'btn btn-primary glyphicon glyphicon-save-file' },
                    { extend: 'excel', title:'Reporte Inmuebles Activos', text:' Excel',className: 'btn btn-primary glyphicon glyphicon-list-alt' },
                    { extend: 'pdf', title:'Reporte Inmuebles Activos', text:' PDF',  className: 'btn btn-primary glyphicon glyphicon-file' },
                    {extend:'print',title:'Reporte Inmuebles Activos',text:' Imprimir', className: 'btn btn-primary glyphicon glyphicon-print' }
                ],
