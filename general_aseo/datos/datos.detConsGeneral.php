...
//$fname = "USERNME";
    ...
    $l         = new Inmueble();
    $registros = $l->getFacByInmFlexyAseo($where, $sort, $start, $end);
    $total     = 111;
    $json      = "";
    $json .= "{\n";
    $json .= "page: $page,\n";
...
//$where = " AND FACTURA='$factura'";
    ...
    $l         = new Factura();
    $registros = $l->getDetFacByFacFlexyAseo($where, $sort, $start, $end, $factura);
...
if ($tipo == 'fielSetInm') {
    ...
    $l        = new Inmueble();
    $inmueble = $_REQUEST['inm'];
    $datos    = $l->GetDatInmByCodAseo($inmueble);
    $i        = 0;
...
//$fname = "USERNME";
    ...
    $l         = new Pago();
    $registros = $l->getPagByInmFlexyAseo($where, $sort, $start, $end);
    $total     = countRec($fname, $tname, $where, $sort);
    $json      = "";
    $json .= "{\n";
    $json .= "page: $page,\n";
...
//$fname = "USERNME";
    ...
    $l         = new Pago();
    $registros = $l->getPagAplFacByPagFlexyAseo($where, $sort, $start, $end);
    $total     = countRec($fname, $tname, $where, $sort);
    $json      = "";
    $json .= "{\n";
    $json .= "page: $page,\n";
...
//$periodo = date('Ym');
    $end   = ($page - 1) * $rp; // MAX_ROW_TO_FETCH
    $start = ($page) * $rp; // MIN_ROW_TO_FETCH
    $where = " AND S.COD_INMUEBLE = '$codinmueble' AND O.COD_SERVICIO = 5";
    ...
    $l         = new Inmueble();
    $registros = $l->getSerByInmFlexyAseo($where, $sort, $start, $end);
    $json      = "";
    $json .= "{\n";
    $json .= "page: $page,\n";
//$json .= "total: 1,\n";
