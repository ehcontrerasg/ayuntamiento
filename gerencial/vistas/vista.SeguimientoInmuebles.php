...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <!--logica pag    -->
        <script type="text/javascript" src="../js/IndicadoresSeguimiento.js?<?echo time();?>"></script>
    </head>
    <body>
    <header>
        <div class="cabecera">
            Indicadores del Seguimiento de Inmuebles
        </div>
    </header>
    <section>
        <article>
            <form onSubmit="return false" id="frmIndicadores">
                ...
                <div class="divfiltros">
                    <div class="contenedor">
                        <label> Período: </label>
                        <input type="number" id="txtPeriodo" name="periodo"/>
                    </div>
                    <div class="contenedor">
