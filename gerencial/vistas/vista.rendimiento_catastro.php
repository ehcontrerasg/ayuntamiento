...
<head>
    ...
    <title>Rendimiento Catastro</title>
    <!-- alertas -->
    ...
    <!--logica pag    -->
    <script type="text/javascript" src="../js/rendimientocatastro.js?1"></script>
</head>
<body>
<header>
    <!--div class="cabecera">
        ...
        <form onSubmit="return false" id="genRepAntMedForm"><!--1-->
            ...
            <div class="divfiltros">
                ...
                <div class="contenedor">
                    ...
                    <select id="selEmpAntMed" name="empleado" autofocus="true" required></select><!--1-->
                </div>
                <div class="contenedor">
                    <label> Periodo inicial: </label>
                    <input type="number" id="selRutAntMed" required name="fecini">
                </div>
                <div class="contenedor">
                    <label> Periodo Final: </label>
                    <input type="number" id="selUsoAntMed" required name="fecfin">
                </div>
