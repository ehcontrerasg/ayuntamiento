...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <title>Reporte Seguimiento Conciliaci&nbsp;n</title>
        <!-- alertas -->
        ...
        <!--logica pag    -->
        <script type="text/javascript" src="../js/repSegCon.js?<?php echo time();?>"></script>
    </head>
    <body>
    <header>
        <div class="cabecera">
        ...
        <article>
            <form onSubmit="return false" id="genRepSegFacForm">
                <div class="subCabecera">
                    Filtros de Búsqueda Reporte Conciliación
                </div>
                <div class="divfiltros">
                    ...
                    <div class="contenedor">
                        <label>Año: </label>
                        <input type="number" id="inpPerHisFac" placeholder="Año" name="periodo" required>
                    </div>
                    <div class="contenedor">
