...
<head>
    ...
    <!--logica pag    -->
    <script type="text/javascript" src="../js/rendcat.js?1"></script>
</head>
<body>
<header>
    <!--div class="cabecera">
        ...
        <form onSubmit="return false" id="genRepAntMedForm"><!--1-->
            ...
            <div class="divfiltros">
                ...
                <div class="contenedor">
                    ...
                    <input type="date" id="selRutAntMed" required name="fecini">
                </div>
                <div class="contenedor">
                    <label> Fecha Final: </label>
                    <input type="date" id="selUsoAntMed" required name="fecfin">
                </div>
