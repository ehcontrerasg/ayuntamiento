...
<head>
    ...
    <title>Rendimiento Reconexion</title>
    <!-- alertas -->
    ...
    <!--estilo pag    -->
    <link rel="stylesheet" type="text/css" href="../css/gerencia.css?4" />
    <!--logica pag    -->
    <script type="text/javascript" src="../js/rendrec.js?1"></script>
</head>
<body>
<header>
    <!--div class="cabecera">
        ...
        <form onSubmit="return false" id="genRepAntMedForm"><!--1-->
            ...
            <div class="divfiltros">
                ...
                <div class="contenedor">
                    ...
                    <select id="selContAntMed" name="contratista" autofocus="true" required></select><!--1-->
                </div>

                <div class="contenedor">
                    <label> Fecha inicial: </label>
                    <input type="date"  required name="fecini">
                </div>
                <div class="contenedor">
                    <label> Fecha Final: </label>
                    <input type="date"  required name="fecfin">
                </div>
