...
<div id="content">
    <form name="repofac" action="vista.reportes_gerencia.php" method="post">
        <h3 class="panel-heading" style=" background-color:#008B8E; color:#FFFFFF; font-size:18px;" align="center">Reportes De Rendimiento</h3>
            ...
            <table width="100%">
                <tr>
                    <td align="center" width="20%">
                        <button type="submit" name="rendlect" id="rendlect" class="btn btn btn-INFO"  data-toggle="modal" data-target="#consultar-1"
                                style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#008B8E; color:#008B8E; width:200px; height:100px">
                            <p><i class="fa fa-line-chart fa-lg"></i></p>Rendimiento de lectura
                        </button>
                    </td>
                    <td align="center" width="20%">
                        <button type="submit" name="rendfact" id="rendfact" class="btn btn btn-INFO"  data-toggle="modal" data-target="#consultar-1"
                                style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#008B8E; color:#008B8E; width:200px; height:100px">
                            <p><i class="fa fa-line-chart fa-lg"></i></p>Rendimiento Entrega<br /> de Facturas
                        </button>
                    </td>
                    <td align="center" width="20%">
                        <button type="submit" name="rendcat" id="rendcat" class="btn btn btn-INFO"  data-toggle="modal" data-target="#consultar-1"
                                style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#008B8E; color:#008B8E; width:200px; height:100px">
                            <p><i class="fa fa-history fa-lg"></i></p>Rendimiento Catastro
                        </button>
                    </td>

                    <td align="center" width="20%">
                        <button type="submit" name="rendcor" id="rendcor" class="btn btn btn-INFO"  data-toggle="modal" data-target="#consultar-1"
                                style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#008B8E; color:#008B8E; width:200px; height:100px">
                            <p><i class="fa fa-history fa-lg"></i></p>Rendimiento Cortes
                        </button>
                    </td>

                    <td align="center" width="20%">
                        <button type="submit" name="rendrec" id="rendrec" class="btn btn btn-INFO"  data-toggle="modal" data-target="#consultar-1"
                                style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#008B8E; color:#008B8E; width:200px; height:100px">
                            <p><i class="fa fa-history fa-lg"></i></p>Rendimiento Reconexiones
                        </button>
                    </td>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('.btn-INFO').on('click',function(e){
                ...
                switch (id) {
                    case 'rendlect':
                        url = 'vista.rendlect.php'
                        break;
                    case 'rendfact':
                        url = 'vista.rendfact.php'
                        break;
                    case 'rendcat':
                        url = 'vista.rendcat.php'
                        break;
                    case 'rendcor':
                        url = 'vista.rendcor.php'
                        break;
                    case 'rendrec':
                        url = 'vista.rendrec.php'
                        break;
