...
<head>
    ...
    <link href="../css/encabezado.css?3" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="../js/reporte_pagos_x_caja.js?21"></script>
...
<section class="contenido">
    <article>
        <form onSubmit="return false" id="repPagos">



            <span class="datoForm col1">
               <span class="titDato numCont2">Acueducto:</span>
                <span class="inpDatp numCont2"><select name="proyecto" tabindex="1" select id="proyecto" required ></select></span>

               <span class="titDato numCont2">Fecha Ini:</span>
                <span class="inpDatp numCont2"><input name="fecha_ini" tabindex="2" id="fecha_ini" required placeholder="fecha inicial" type="date"></span>

               <span class="titDato numCont2">Peiodo:</span>
                <span class="inpDatp numCont2"><input name="fecha_fin" tabindex="2" id="fecha_fin" required placeholder="fecha fin" type="date"></span>
            ...
            <span class="datoForm col1">
              <span class="titDato numCont2">Entidad:</span>
                <span class="inpDatp numCont2"><select name="entidad" tabindex="1" select id="entidad" ></select></span>

               <span class="titDato numCont2">Punto:</span>
                <span class="inpDatp numCont2"><select name="punto" tabindex="1" select id="punto"  ></select></span>

               <span class="titDato numCont2">Caja:</span>
                <span class="inpDatp numCont2"><input name="caja" tabindex="2" id="caja"  placeholder="caja" type="number"></span>
            ...
            <span class="datoForm col1">
                <input type="submit" value="Generar" class="botonFormulario botFormGer" tabindex="9" id="generar_rep">
            </span>
