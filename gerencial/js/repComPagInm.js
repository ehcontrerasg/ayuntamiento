...
function generaRep(){
    var datos=$("#genRepComPagInmForm").serializeArray();
    $.ajax
    ({
...
function llenarSpinerPro()
{
    ...
    ({
        ...
        success : function(json) {
            $('#selProyComPagInm').append(new Option('', '', true, true));
            for(var x=0;x<json.length;x++)
                $('#selProyComPagInm').append(new Option(json[x]["SIGLA_PROYECTO"], json[x]["ID_PROYECTO"], false, false));
        },
        error : function(xhr, status) {
