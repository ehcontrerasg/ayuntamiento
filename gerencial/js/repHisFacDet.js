...
function repDetFactInicio(){
	...
	genRepHistForm=document.getElementById("genRepHisFacDetForm");
...
function repHistSelPro(){
    ...
    xmlhttp.open("POST", "../datos/datos.datRepHisFacDet.php", true);   // async
...
function genRepHistFac(){
    ...
    var datos=$("#genRepHisFacDetForm").serializeArray();
    datos.push({name:'tip',value:'repHist'});
    $.ajax
    ({
        url : '../datos/datos.datRepHisFacDet.php',
        type : 'POST',
        dataType : 'text',
        data : datos ,
