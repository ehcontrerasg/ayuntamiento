...
include '../clases/class.repSegRec.php';
...
getProperties()
    ...
    ->setTitle("Seguimiento Recaudo ".$proyecto." ".$fecini. " al ".$fecfin)
    ->setSubject("")
...
//HOJA RECAUDADO POR CLIENTE POR CONCEPTO
...
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('A1', 'REPORTE RECAUDO POR CLIENTE Y CONCEPTO '. $acueducto .' '. $periodo)
...
$c=new ReportesSegRec();
$fila = 4;
$registros=$c->historicoRecaudoClienteConcepto($proyecto, $fecini, $fecfin);
