...
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('A1', 'RENDIMIENTO FACTURAS '.$empleado.' DE '.$fecini.' AL '.$fecfin)
    ->setCellValue('A2', 'DIA')
...
$fila = 3;
$cantinm = 0;
$registros=$c->rendFacEmp($empleado,$fecini,$fecfin);
...
$nomarch="../../temp/RendimientoFacturas-".$usuario.'-del-'.$fecini.' al '.$fecfin.".xlsx";
