...
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('A1', 'RENDIMIENTO CATASTRO '.$empleado.' DE '.$fecini.' AL '.$fecfin)
    ->setCellValue('A2', 'DIA')
...
$fila = 3;
$cantinm = 0;
$registros=$c->rendCatEmp($proyecto,$empleado,$fecini,$fecfin);
...
$nomarch="../../temp/RendimientoCatastro-".$usuario.'-del-'.$fecini.' al '.$fecfin.".xlsx";
