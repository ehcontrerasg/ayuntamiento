...
include '../clases/class.repAnaCon.php';
...
$estiloTitulos = array(
    ...
    $c=new ReportesAnaCon();
    $fila = 3;
    $cantinm = 0;
    $registros=$c->MedidosDiferencia($proyecto, $sector, $ruta, $cliente, $diametro, $perini, $perfin, $arrayperiodo);
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells("A".$fila.":E".$fila);
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('A'.$fila, 'Clientes Medidos Facturados por Diferencia: '.$cantinm);
...
$objPHPExcel->setActiveSheetIndex(0)
    ...
    $objPHPExcel->getActiveSheet(0)->setTitle('Medidos Diferencia');

   //HOJA INMUEBLES MEDIDOS POR DIFERENCIA PROMEDIO

$myWorkSheet = new PHPExcel_Worksheet($objPHPExcel, 'Medidos Diferencia - Cupo');
$objPHPExcel->addSheet($myWorkSheet, 1);

$objPHPExcel->setActiveSheetIndex(1)->mergeCells('A1:Q1');
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A1:Q1')->applyFromArray($estiloTitulos);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A2:Q2')->applyFromArray($estiloTitulos);
$objPHPExcel->setActiveSheetIndex(1)->getStyle("A1:Q1")->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(1)->getStyle("A2:Q2")->getFont()->setBold(true);
...
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("I")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("J")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("K")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("L")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("M")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("N")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("O")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("P")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("Q")->setWidth(15);

unset($totalperiodos,$totalperiodo1,$totalperiodo2,$totalperiodo3,$totalperiodo4,$totalperiodo5,$totalperiodo6,$totalperiodo7
    ,$totalperiodo8,$totalperiodo9,$totalperiodo10,$totalperiodo11,$totalperiodo12,$totalperiodo13);

$c=new ReportesAnaCon();
$fila = 3;
$cantinm = 0;
$registros=$c->MedidosDiferenciaCupo($proyecto, $sector, $ruta, $cliente, $diametro, $perini, $perfin, $arrayperiodo);
while (oci_fetch($registros)) {
    $inmueble=utf8_decode(oci_result($registros,"CODIGO_INM"));
    $uso=utf8_decode(oci_result($registros,"ID_USO"));
    $diametroa=utf8_decode(oci_result($registros,"DESC_CALIBRE"));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle("A".$fila.":Q".$fila)->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(1)
    ->setCellValue('A'.$fila, 'Total mts')
    ->setCellValue('D'.$fila, $totalperiodo1)
    ->setCellValue('E'.$fila, $totalperiodo2)
...
$objPHPExcel->setActiveSheetIndex(1)->mergeCells("A".$fila.":E".$fila);
$objPHPExcel->setActiveSheetIndex(1)
    ->setCellValue('A'.$fila, 'Clientes Medidos Facturados por Diferencia - Cupo: '.$cantinm);
...
$objPHPExcel->setActiveSheetIndex(1)
    ...
    //HOJA INMUEBLES MEDIDOS POR PROMEDIO

$myWorkSheet = new PHPExcel_Worksheet($objPHPExcel, 'Medidos Promedio');
$objPHPExcel->addSheet($myWorkSheet, 2);

$objPHPExcel->setActiveSheetIndex(2)->mergeCells('A1:Q1');
$objPHPExcel->setActiveSheetIndex(2)->getStyle('A1:Q1')->applyFromArray($estiloTitulos);
$objPHPExcel->setActiveSheetIndex(2)->getStyle('A2:Q2')->applyFromArray($estiloTitulos);
$objPHPExcel->setActiveSheetIndex(2)->getStyle("A1:Q1")->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(2)->getStyle("A2:Q2")->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(2)
    ...
    ->setCellValue('P2', $vectorperiodo[12])
    ->setCellValue('Q2', 'TOTAL METROS');
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("A")->setWidth(12);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("B")->setWidth(10);
...
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("E")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("F")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("G")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("H")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("I")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("J")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("K")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("L")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("M")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("N")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("O")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("P")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(2)->getColumnDimension("Q")->setWidth(15);
...
$fila = 3;
$cantinm = 0;
$registros=$c->MedidosPromedio($proyecto, $sector, $ruta, $cliente, $diametro, $perini, $perfin, $arrayperiodo);
while (oci_fetch($registros)) {
    $inmueble=utf8_decode(oci_result($registros,"CODIGO_INM"));
    $uso=utf8_decode(oci_result($registros,"ID_USO"));
    $diametroa=utf8_decode(oci_result($registros,"DESC_CALIBRE"));
...
$totalperiodos = $totalperiodo1+$totalperiodo2+$totalperiodo3+$totalperiodo4+$totalperiodo5+$totalperiodo6+$totalperiodo7
    +$totalperiodo8+$totalperiodo9+$totalperiodo10+$totalperiodo11+$totalperiodo12+$totalperiodo13;
$objPHPExcel->setActiveSheetIndex(2)->mergeCells("A".$fila.":C".$fila);
$objPHPExcel->setActiveSheetIndex(2)->getStyle("A".$fila.":Q".$fila)->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(2)
    ->setCellValue('A'.$fila, 'Total mts')
    ->setCellValue('D'.$fila, $totalperiodo1)
    ->setCellValue('E'.$fila, $totalperiodo2)
...
$objPHPExcel->setActiveSheetIndex(2)->getStyle("A".$fila.":E".$fila)->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(2)
    ->setCellValue('A'.$fila, 'RESUMEN:');
$fila++;
$objPHPExcel->setActiveSheetIndex(2)->mergeCells("A".$fila.":E".$fila);
$objPHPExcel->setActiveSheetIndex(2)
    ->setCellValue('A'.$fila, 'Clientes Medidos Facturados por Promedio: '.$cantinm);
...
//HOJA INMUEBLES MEDIDOS TOTAL

$myWorkSheet = new PHPExcel_Worksheet($objPHPExcel, 'Medidos Total');
$objPHPExcel->addSheet($myWorkSheet, 3);

$objPHPExcel->setActiveSheetIndex(3)->mergeCells('A1:Q1');
$objPHPExcel->setActiveSheetIndex(3)->getStyle('A1:Q1')->applyFromArray($estiloTitulos);
$objPHPExcel->setActiveSheetIndex(3)->getStyle('A2:Q2')->applyFromArray($estiloTitulos);
$objPHPExcel->setActiveSheetIndex(3)->getStyle("A1:Q1")->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(3)->getStyle("A2:Q2")->getFont()->setBold(true);
...
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("B")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("C")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("D")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("E")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("F")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("G")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("H")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("I")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("J")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("K")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("L")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("M")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("N")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("O")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("P")->setWidth(10);
$objPHPExcel->setActiveSheetIndex(3)->getColumnDimension("Q")->setWidth(15);
...
$fila = 3;
$cantinm = 0;
$registros=$c->MedidosTodos($proyecto, $sector, $ruta, $cliente, $diametro, $perini, $perfin, $arrayperiodo);
while (oci_fetch($registros)) {
    $inmueble=utf8_decode(oci_result($registros,"CODIGO_INM"));
    $uso=utf8_decode(oci_result($registros,"ID_USO"));
    $diametroa=utf8_decode(oci_result($registros,"DESC_CALIBRE"));
...
$totalperiodos = $totalperiodo1+$totalperiodo2+$totalperiodo3+$totalperiodo4+$totalperiodo5+$totalperiodo6+$totalperiodo7
    +$totalperiodo8+$totalperiodo9+$totalperiodo10+$totalperiodo11+$totalperiodo12+$totalperiodo13;
$objPHPExcel->setActiveSheetIndex(3)->mergeCells("A".$fila.":C".$fila);
$objPHPExcel->setActiveSheetIndex(3)->getStyle("A".$fila.":Q".$fila)->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(3)
    ->setCellValue('A'.$fila, 'Total mts')
    ->setCellValue('D'.$fila, $totalperiodo1)
    ->setCellValue('E'.$fila, $totalperiodo2)
...
$objPHPExcel->setActiveSheetIndex(3)->mergeCells("A".$fila.":E".$fila);
$objPHPExcel->setActiveSheetIndex(3)->getStyle("A".$fila.":E".$fila)->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(3)
    ->setCellValue('A'.$fila, 'RESUMEN:');
$fila++;
$objPHPExcel->setActiveSheetIndex(3)->mergeCells("A".$fila.":E".$fila);
$objPHPExcel->setActiveSheetIndex(3)
    ->setCellValue('A'.$fila, 'Total Clientes Medidos Facturados: '.$cantinm);
...
$objPHPExcel->setActiveSheetIndex(3)
    ...
    $nomarch="../../temp/AnalisisConsumo-".$proyecto.'-'.$perini.'-'.$perfin.".xlsx";
