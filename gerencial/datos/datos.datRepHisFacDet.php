...
$objPHPExcel->
	...
	while (oci_fetch($registros)) {
		...
		->setCellValue($fila1.'1',"REPORTE HISTORICO FACTURACION POR SECTOR ".$proyecto."  " .$periodorango );
        ...
        for ($i = 1; $i <= 11; $i++) {
            ...
            if($i==1) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue($fila3 . '2', "FACTURADO TOTAL");
                ...
                $temp=$fila3;
                $temp++;
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue($temp . '3', "No Facturas");
                ...
                $registros2=$c2->getHistFactPerSec($proyecto,$periodorango,"");
                $col=3;
            ...
            if($i==5) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue($fila3 . '2', "FACTURADO NORTE");
                $objPHPExcel->setActiveSheetIndex(0)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(0)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(0)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerSec($proyecto,$periodorango,"N");
                $col=3;
            ...
            if($i==9) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue($fila3 . '2', "FACTURADO ESTE");
                $objPHPExcel->setActiveSheetIndex(0)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(0)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(0)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerSec($proyecto,$periodorango,"E");
                $col=3;
...
//////////////////// INICIA HOJA 2
    ...
    while (oci_fetch($registros)) {
        ...
        $objPHPExcel->setActiveSheetIndex(1)
            ->setCellValue($fila1.'1',"REPORTE HISTORICO FACTURACION POR CONCEPTO ".$proyecto."  " .$periodorango );
        ...
        for ($i = 1; $i <= 11; $i++) {
            ...
            if($i==1) {
                ...
                $objPHPExcel->setActiveSheetIndex(1)->setCellValue($fila3 . '2', "FACTURADO TOTAL");
                ...
                $objPHPExcel->setActiveSheetIndex(1)->setCellValue($fila4 . '3', "Facturado");
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerCon($proyecto,$periodorango,"");
                $col=3;
            ...
            if($i==5) {
                ...
                $objPHPExcel->setActiveSheetIndex(1)->setCellValue($fila3 . '2', "FACTURADO NORTE");
                $objPHPExcel->setActiveSheetIndex(1)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(1)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(1)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerCon($proyecto,$periodorango,"N");
                $col=3;
                $totalfacturado=0;
                while (oci_fetch($registros2)) {
                    $col++;
            ...
            if($i==9) {
                ...
                $objPHPExcel->setActiveSheetIndex(1)->setCellValue($fila3 . '2', "FACTURADO ESTE");
                $objPHPExcel->setActiveSheetIndex(1)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(1)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(1)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerCon($proyecto,$periodorango,"E");
                $col=3;
                $totalfacturado=0;
                while (oci_fetch($registros2)) {
                    $col++;
...
//////////////////// INICIA HOJA 3
    ...
    while (oci_fetch($registros)) {
        ...
        $objPHPExcel->setActiveSheetIndex(2)
            ->setCellValue($fila1.'1',"REPORTE HISTORICO FACTURACION POR USO SD ".$proyecto."  " .$periodorango );
        ...
        for ($i = 1; $i <= 11; $i++) {
            ...
            if($i==1) {
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($fila3 . '2', "FACTURADO TOTAL");
                ...
                $temp=$fila3;
                $temp++;
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($temp . '3', "No facturas");
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($fila4 . '3', "Facturado");
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerUso($proyecto,$periodorango,"");
                $col=3;
                $totalfacturado=0;
                $totalfacturas=0;
                while (oci_fetch($registros2)) {
            ...
            if($i==5) {
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($fila3 . '2', "FACTURADO NORTE");
                $objPHPExcel->setActiveSheetIndex(2)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(2)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(2)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerUso($proyecto,$periodorango,"N");
                $col=3;
                $totalfacturado=0;
                $totalfacturas=0;
                while (oci_fetch($registros2)) {
            ...
            if($i==9) {
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($fila3 . '2', "FACTURADO ESTE");
                $objPHPExcel->setActiveSheetIndex(2)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(2)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(2)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerUso($proyecto,$periodorango,"E");
                $col=3;
                $totalfacturado=0;
                $totalfacturas=0;
                while (oci_fetch($registros2)) {
...
//////////////////// INICIA HOJA 4
    ...
    while (oci_fetch($registros)) {
        ...
        $objPHPExcel->setActiveSheetIndex(3)
            ->setCellValue($fila1.'1',"REPORTE HISTORICO FACTURACION MEDIDOS POR CONCEPTO SD ".$proyecto."  " .$periodorango );
        ...
        for ($i = 1; $i <= 11; $i++) {
            ...
            if($i==1) {
                ...
                $objPHPExcel->setActiveSheetIndex(3)->setCellValue($fila3 . '2', "FACTURADO TOTAL");
                ...
                $objPHPExcel->setActiveSheetIndex(3)->setCellValue($fila4 . '3', "Facturado");
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerConMed($proyecto,$periodorango,"");
                $col=3;
                $totalfacturado=0;
                while (oci_fetch($registros2)) {
                    $col++;
            ...
            if($i==5) {
                ...
                $objPHPExcel->setActiveSheetIndex(3)->setCellValue($fila3 . '2', "FACTURADO NORTE");
                $objPHPExcel->setActiveSheetIndex(3)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(3)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(3)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerConMed($proyecto,$periodorango,"N");
                $col=3;
                $totalfacturado=0;
                while (oci_fetch($registros2)) {
                    $col++;
            ...
            if($i==9) {
                ...
                $objPHPExcel->setActiveSheetIndex(3)->setCellValue($fila3 . '2', "FACTURADO ESTE");
                $objPHPExcel->setActiveSheetIndex(3)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(3)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(3)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerConMed($proyecto,$periodorango,"E");
                $col=3;
                $totalfacturado=0;
                while (oci_fetch($registros2)) {
                    $col++;
...
//////////////////// INICIA HOJA 4
    ...
    while (oci_fetch($registros)) {
        ...
        $objPHPExcel->setActiveSheetIndex(4)
            ->setCellValue($fila1.'1',"REPORTE HISTORICO FACTURACION POR CONCEPTO AGRUPADO SD ".$proyecto."  " .$periodorango );
        ...
        for ($i = 1; $i <= 11; $i++) {
            ...
            if($i==1) {
                ...
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($fila3 . '2', "FACTURADO TOTAL");
                ...
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($fila4 . '3', "Facturado");
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerConAgrup($proyecto,$periodorango,"");
                $col=3;
                $totalfacturado=0;
                while (oci_fetch($registros2)) {
                    $col++;
            ...
            if($i==5) {
                ...
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($fila3 . '2', "FACTURADO NORTE");
                $objPHPExcel->setActiveSheetIndex(4)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(4)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(4)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerConAgrup($proyecto,$periodorango,"N");
                $col=3;
                $totalfacturado=0;
                while (oci_fetch($registros2)) {
                    $col++;
            ...
            if($i==9) {
                ...
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($fila3 . '2', "FACTURADO ESTE");
                $objPHPExcel->setActiveSheetIndex(4)->mergeCells($fila3 . '2:' . $fila4 . '2');
                $objPHPExcel->setActiveSheetIndex(4)->getStyle($fila3 . '2:' . $fila4 . '2')->applyFromArray($estiloTitulos);
                $objPHPExcel->setActiveSheetIndex(4)->getStyle($fila3 . '2:' . $fila4 . '2')->getFont()->setBold(true);
                ...
                $c2=new ReportesGerencia();
                $registros2=$c2->getHistFactPerConAgrup($proyecto,$periodorango,"E");
                $col=3;
                $totalfacturado=0;
                while (oci_fetch($registros2)) {
                    $col++;
...
// FIN HOJA 5
    ...
    $nomarch="../../temp/Historico_fac_detallado".$proyecto."_".$periodoini."-".$periodofin.".xlsx";
