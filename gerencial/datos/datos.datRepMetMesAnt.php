...
if($tipo=='MetMesAnt'){
	...
	getProperties()
		...
		->setTitle("Comparativo M3 Mes Anterior")
		->setSubject("")
	...
	if ($proyecto<>'BC'){
        ...
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A2:A3')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('B2:D2')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('B3:D3')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A11:D11')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("A1:D1")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("A2:A3")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("B2:D2")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("B3:D3")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("A4:A10")->getFont()->setBold(true);

        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A4:D10')->applyFromArray($estiloLineaLateral);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A17:D23')->applyFromArray($estiloLineaLateral);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A30:D36')->applyFromArray($estiloLineaLateral);
    }
    ...
    if($proyecto<>'BC') {
        ...
        while (oci_fetch($registros)) {
            ...
            if ($des_uso == 'ZF Oficial') $fila = 4567;
            if ($des_uso == 'ZF Industrial') $fila = 9;
            if ($des_uso == 'ZF Comercial') $fila = 10;
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('E' . $fila, $cant1)
                ->setCellValue('F' . $fila, $cant2)
                ->setCellValue('G' . $fila, $variacion);
    ...
    if($proyecto<>'BC'){
        ...
        $objPHPExcel->setActiveSheetIndex(0)->mergeCells('A15:A16');
        $objPHPExcel->setActiveSheetIndex(0)->mergeCells('B15:D15');
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A14:D14')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A15:A16')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('B15:D15')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('B16:D16')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A24:D24')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("A14:D14")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("A15:A16")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("B15:D15")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("B16:D16")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("A17:A23")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A14', 'VOLUMEN AGUA DE RED FACTURADA EN M3 - USUARIOS SIN MEDIDOR  '.$proyecto.' PERIODO '.$periodo)
            ->setCellValue('A15', 'Uso')
    ...
    if ($proyecto<>'BC'){
        ...
        $objPHPExcel->setActiveSheetIndex(0)->mergeCells('A27:D27');
        $objPHPExcel->setActiveSheetIndex(0)->mergeCells('A28:A29');
        $objPHPExcel->setActiveSheetIndex(0)->mergeCells('B28:D28');
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A27:D27')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A28:A29')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('B28:D28')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('B29:D29')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle('A37:D37')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("A27:D29")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)->getStyle("A30:A36")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A27', 'VOLUMEN AGUA DE RED FACTURADA EN M3 - TOTAL  '.$proyecto.' PERIODO '.$periodo)
            ->setCellValue('A28', 'Uso')
    ...
    if ($proyecto<>'BC'){
        ...
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A12:D13')->applyFromArray($estiloNoLineas);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A25:D26')->applyFromArray($estiloNoLineas);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A38:D99')->applyFromArray($estiloNoLineas);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A4:D10')->applyFromArray($estiloLineaLateral);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A17:D23')->applyFromArray($estiloLineaLateral);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A30:D36')->applyFromArray($estiloLineaLateral);
        $objPHPExcel->setActiveSheetIndex(1)->mergeCells('A1:D1');
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A1:D1')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('B2:D2')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('B3:D3')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A11:D11')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle("A1:D1")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle("B2:D2")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle("B3:D3")->getFont()->setBold(true);
    }
    ...
    if ($proyecto<>'BC'){
        ...
        $objPHPExcel->setActiveSheetIndex(1)
            ...
            ->setCellValue('A9', 'ZF Industrial')
            ->setCellValue('A10', 'ZF Comercial');
        $objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("A")->setWidth(24);
        $objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("B")->setWidth(24);
        $objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("C")->setWidth(24);
        $objPHPExcel->setActiveSheetIndex(1)->getColumnDimension("D")->setWidth(24);
    }


	$c=new ReportesGerencia();
	$registros=$c->MetrosMesAnteriorMedidosEstePozo($proyecto, $periodo);
	while (oci_fetch($registros)) {
		$des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
		$cant1=utf8_decode(oci_result($registros,"'$perini'"));
		$cant2=utf8_decode(oci_result($registros,"'$perfin'"));
	...
	$c=new ReportesGerencia();
	$registros=$c->MetrosMesAnteriorMedidosEsteZFPozo($proyecto, $periodo);
	while (oci_fetch($registros)) {
		$des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
		$cant1=utf8_decode(oci_result($registros,"'$perini'"));
		$cant2=utf8_decode(oci_result($registros,"'$perfin'"));
    ...
    if($proyecto<>'BC'){
        $c=new ReportesGerencia();
        $registros=$c->MetrosMesAnteriorMedidosNortePozo($proyecto, $periodo);
        while (oci_fetch($registros)) {
            $des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
            $cant1=utf8_decode(oci_result($registros,"'$perini'"));
            $cant2=utf8_decode(oci_result($registros,"'$perfin'"));
        ...
        $c=new ReportesGerencia();
        $registros=$c->MetrosMesAnteriorMedidosNorteZFPozo($proyecto, $periodo);
        while (oci_fetch($registros)) {
            $des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
            $cant1=utf8_decode(oci_result($registros,"'$perini'"));
            $cant2=utf8_decode(oci_result($registros,"'$perfin'"));
        ...
        $c=new ReportesGerencia();
        $registros=$c->MetrosMesAnteriorMedidosTotalPozo($proyecto, $periodo);
        while (oci_fetch($registros)) {
            $des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
            $cant1=utf8_decode(oci_result($registros,"'$perini'"));
            $cant2=utf8_decode(oci_result($registros,"'$perfin'"));
        ...
        $c=new ReportesGerencia();
        $registros=$c->MetrosMesAnteriorMedidosTotalZFPozo($proyecto, $periodo);
        while (oci_fetch($registros)) {
            $des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
            $cant1=utf8_decode(oci_result($registros,"'$perini'"));
            $cant2=utf8_decode(oci_result($registros,"'$perfin'"));
	...
	if($proyecto<>'BC'){
        ...
        $objPHPExcel->setActiveSheetIndex(1)->mergeCells('A14:D14');
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A14:D14')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('B15:D15')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('B16:D16')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A24:D24')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle("A14:D14")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle("B15:D15")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle("B16:D16")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(1)
            ->setCellValue('A14', 'VOLUMEN AGUA DE POZO FACTURADA EN M3 - USUARIOS SIN MEDIDOR  '.$proyecto.' PERIODO '.$periodo)
            ->setCellValue('A15', 'Uso')
            ->setCellValue('B15', 'Zona Este')
	...
	$c=new ReportesGerencia();
	$registros=$c->MetrosMesAnteriorNoMedidosEstePozo($proyecto, $periodo);
	while (oci_fetch($registros)) {
		$des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
		$cant1=utf8_decode(oci_result($registros,"'$perini'"));
		$cant2=utf8_decode(oci_result($registros,"'$perfin'"));
	...
	$c=new ReportesGerencia();
	$registros=$c->MetrosMesAnteriorNoMedidosEsteZFPozo($proyecto, $periodo);
	while (oci_fetch($registros)) {
		$des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
		$cant1=utf8_decode(oci_result($registros,"'$perini'"));
		$cant2=utf8_decode(oci_result($registros,"'$perfin'"));
    ...
    if($proyecto<>'BC'){
        $c=new ReportesGerencia();
        $registros=$c->MetrosMesAnteriorNoMedidosNortePozo($proyecto, $periodo);
        while (oci_fetch($registros)) {
            $des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
            $cant1=utf8_decode(oci_result($registros,"'$perini'"));
            $cant2=utf8_decode(oci_result($registros,"'$perfin'"));
        ...
        $c=new ReportesGerencia();
        $registros=$c->MetrosMesAnteriorNoMedidosNorteZFPozo($proyecto, $periodo);
        while (oci_fetch($registros)) {
            $des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
            $cant1=utf8_decode(oci_result($registros,"'$perini'"));
            $cant2=utf8_decode(oci_result($registros,"'$perfin'"));
        ...
        $c=new ReportesGerencia();
        $registros=$c->MetrosMesAnteriorNoMedidosTotalPozo($proyecto, $periodo);
        while (oci_fetch($registros)) {
            $des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
            $cant1=utf8_decode(oci_result($registros,"'$perini'"));
            $cant2=utf8_decode(oci_result($registros,"'$perfin'"));
        ...
        $c=new ReportesGerencia();
        $registros=$c->MetrosMesAnteriorNoMedidosTotalZFPozo($proyecto, $periodo);
        while (oci_fetch($registros)) {
            $des_uso=utf8_decode(oci_result($registros,"DESC_USO"));
            $cant1=utf8_decode(oci_result($registros,"'$perini'"));
            $cant2=utf8_decode(oci_result($registros,"'$perfin'"));
	...
	if ($proyecto<>'BC'){
        ...
        $objPHPExcel->setActiveSheetIndex(1)->mergeCells('A27:D27');
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A27:D27')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('B28:D28')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('B29:D29')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle('A37:D37')->applyFromArray($estiloTitulos);
        $objPHPExcel->setActiveSheetIndex(1)->getStyle("A27:D29")->getFont()->setBold(true);
        $objPHPExcel->setActiveSheetIndex(1)
            ->setCellValue('A27', 'VOLUMEN AGUA DE POZO FACTURADA EN M3 - TOTAL  '.$proyecto.' PERIODO '.$periodo)
            ->setCellValue('A28', 'Uso')
            ->setCellValue('B28', 'Zona Este')
	...
	header("Content-Disposition: attachment;filename='Comparativo_M3_Mes_Anterior_".$proyecto."_".$periodo.".xls'");
    ...
    $objPHPExcel->setActiveSheetIndex(0);
    $objPHPExcel->getActiveSheet()->setTitle("Comparativo_M3_Mes_Anterior");
    $objPHPExcel->setActiveSheetIndex(0);

    $objWriter = new PHPExcel_Writer_Excel2007($objPHPExcel);
    $nomarch="../../temp/Comparativo_M3_Mes_Anterior_".$proyecto."_".$periodo."-".time().".xlsx";
