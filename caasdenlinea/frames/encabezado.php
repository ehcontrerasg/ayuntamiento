...
<body>
	<div id="header" style="background:linear-gradient(#333333,#0E36D4,#0E36D4);">
		<table width="99%" align="center">
		  <tr>
			  <td height="48" align="center"></td>
				<td width="9%" rowspan="2" align="center" style="color:#FFFFFF"><i class="fa fa-cloud fa-5x"></i> </td>
			  	<td height="48" colspan="4" align="left" class="td" style="vertical-align:bottom"><b>M&Oacute;DULO CAASD EN LINEA</b></td>
		  </tr>
	  	  <tr>
			  <td width="24%" height="51" align="right"></td>
		  	  ...
		  	  <td width="28%" align="left" class="masthead"><font color="#CCC"><b>&nbsp;&nbsp;<?php echo $nomuser;?></b></font></td>
				  ...
				  <a class="btn btn-default btn-sm" href="./../../general/vistas/vista.consulta.php?mod=7" target="jobFrame">
