...
class Incidencias extends  ConexionClass{
    ...
    public function obtenerAverias($motivo,$fechaIn,$fechaFn,$id,$estado)
    {
        ...
        if ($motivo != "")
            $where .= "  TR.ID_TIPO_INCIDENCIA='$motivo' AND ";
        if ($fechaIn != "")
...
";
        ...
        $sql="SELECT
              ...
              WHERE TR.ID=FR.ID_INCIDENCIA
              AND FR.ID_INCIDENCIA='$idReclamo'        
               ";
        ...
        $sql="SELECT  PI.ACTIVO
              FROM  SGC_TP_PERMISOS_INCIDENCIAS PI
              WHERE PI.ID_USUARIO='$usuario'         
               ";
