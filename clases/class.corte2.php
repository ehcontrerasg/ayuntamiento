...
class Corte extends ConexionClass
{
    ...
    public function getCortReaByFecRutSecPer($fecIni, $fecFin, $ruta, $periodo, $usr)
    {
    ...
    public function getCantRutCorPerEje($pro, $sector, $fecini, $fecfin)
    {
        $pro    = addslashes($pro);
    ...
    public function getCantFotCorByDiaInm($fecha, $inm)
    {
    ...
    public function obtenerResumenRutasCort($sort, $start, $end, $pro, $sec, $fecIni, $fecFin)
    {
...
";
    ...
    public function getCortAsigGroupSectorByFech($fecha, $proyecto, $gerencia)
    {
        $where = "";
        if (trim($gerencia) != "") {
    ...
    public function getCortAsigGroupMedByFech($fecha, $proyecto, $gerencia)
    {
        $where = "";
        if (trim($gerencia) != "") {
            " AND S.ID_GERENCIA='$gerencia'";
    ...
    public function getCantCortGroupSecRutByFecAsig($fecha, $asignado, $asignador, $proyecto, $gerencia)
    {
        ...
        $sql = "select I.ID_SECTOR, I.ID_RUTA, COUNT(1) CANTIDAD
              from sgc_tt_registro_cortes rc, SGC_tT_INMUEBLES I, SGC_TP_SECTORES S
                where
                I.CODIGO_INM=RC.ID_INMUEBLE AND
                S.ID_SECTOR=I.ID_SECTOR
                AND
    ...
    public function getDetRutCorByFecUsuRutFlexy($where, $sort, $start, $end)
    {
        ...
        SGC_TT_CONTRATOS O, SGC_TT_CLIENTES L
        WHERE
    ...
    public function getCanDetRutCorByFecUsuRutFlexy($fname, $tname, $where)
    {
        ...
        $sql = "SELECT COUNT(INM.CODIGO_INM)CANTIDAD  FROM SGC_TT_REGISTRO_CORTES C, SGC_TT_INMUEBLES INM
    ...
    {
        $sql = "SELECT DISTINCT URL_FOTO  FROM SGC_TT_FOTOS_CORTE FC,SGC_TT_REGISTRO_CORTES C
        WHERE C.ID_INMUEBLE=FC.ID_INMUEBLE
        AND FC.ID_INMUEBLE='$inmueble'
    ...
    public function getDatCortPagRecByProFecOperProc($proyecto, $fechaIni, $fechaFin, $operario, $procesoIni, $procesoFin)
    {
        $proyecto   = addslashes($proyecto);
