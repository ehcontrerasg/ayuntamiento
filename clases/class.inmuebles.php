...
////////////////////// cantidad datos inmuebles /////////////////////////////////////////

    public function countRecInm($fname,$tname,$where)
    {
 ...
 AND CLI.CODIGO_CLI(+)=C.CODIGO_CLI
    ...
    public function datInmuebles($where, $sort, $start, $end, $from,$qtype,$query)
    {
