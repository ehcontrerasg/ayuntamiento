...
class FPDF
{
    ...
    public $nCell; //number of cells into multicell
 ...
 *******************************************************************************/
    public function FPDF($orientation = 'P', $unit = 'mm', $format = 'A4')
    {
        ...
        $this->PageFormats = array('a3' => array(841.89, 1190.55), 'a4' => array(595.28, 841.89), 'a5'  => array(420.94, 595.28),
            'letter'                        => array(612, 792), 'legal'     => array(612, 1008), 'personal' => array(612, 320), 'a9' => array(595.28, 870.89), 'a7' => array(150, 400));
        if (is_string($format)) {
 ...
 *******************************************************************************/
    ...
    {
        if (!defined('FPDF_FONTPATH') && is_dir(dirname(__FILE__) . '../../recursos/font')) {
            define('FPDF_FONTPATH', dirname(__FILE__) . '../../recursos/font');
        }

        return defined('FPDF_FONTPATH') ? FPDF_FONTPATH : '../../recursos/font/';
    }
    ...
    public function _putimages()
    {
      ...
      //  while (list($file, $info) = each($this->images)) { En php 7.2.0 ya no se usa la funcion each, por lo tanto esta linea de codigo esta obsoleta.
            $this->_newobj();
