...
*/
    ...
    public function seleccionaUltimaCaja($cod_inmueble)
    {
        ...
        FROM SGC_TT_PAGOS_ASEO P, SGC_TP_CAJAS_PAGO CP, SGC_TP_PUNTO_PAGO PP, SGC_TP_ENTIDAD_PAGO EP
    ...
    {
        $sql = "BEGIN
        SGC_P_INGRESA_PAGO_ASEO('$importe1','$referencia','$num_caja','$cod_inmueble','$origen','$coduser','$monto','$cod_pro','$deuda',to_date('$fecha','yyyy-mm-dd'),'$pago_fac','$medio','$importe2','$importe3','$banco','$cheque','$numcard','$tarjeta','$numaproba','$observacion',:PMSGRESULT,:PCODRESULT);
        COMMIT;END;";
        //echo $sql;
        $resultado = oci_parse($this->_db, $sql);
    ...
    FROM SGC_TT_FACTURA_aSEO F, SGC_TT_PAGO_FACTURAS_ASEO PF
    ...
    public function seleccionaDatosReciboPago($id_pago)
    {
        ...
        FROM SGC_TT_PAGOS_ASEO P, SGC_TT_USUARIOS U, SGC_TP_CAJAS_PAGO C, SGC_TP_PUNTO_PAGO V, SGC_TP_ENTIDAD_PAGO E
