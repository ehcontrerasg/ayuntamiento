...
<body>
	<!-- <div id="header" style="background:linear-gradient(#333333,#336699,#336699);">
		<table width="99%" align="center">
		  <tr>
			  <td height="48" align="center"></td>
				<td width="9%" rowspan="2" align="center" style="color:#FFFFFF"><i class="fa fa-tint fa-5x"></i> </td>
			  	<td height="48" colspan="4" align="left" class="td" style="vertical-align:bottom"><b>M&Oacute;DULO FACTURACI&Oacute;N</b></td>
		  </tr>
	  	  <tr>
	...
	<script type="text/javascript" language="javascript">
		...
		<div class="menu" id="menu">
          <div class="logo-acea" >
            ...
            <div class="" >
            <h1><i class="fa fa-trash"></i>&nbsp; Módulo Aseo</h1>
            </div>
            <div id="user-menu">
              ...
              <a class="btn btn-info btn-xs" href="./../../general_aseo/vistas/vista.consulta.php?mod=1" target="jobFrame">
			  	  <i class="fa fa-binoculars"></i>  Consulta General</a>
                  <!--a class="btn btn-info btn-xs" href="./../../general_aseo/vistas/vista.listadoExtensiones.php" target="jobFrame">
                      <i class="fa fa-book"></i>Directorio Telefónico </a-->
              <?php } else {
    ?>
              <a href="../../index.php" target="_top"><i class="glyphicon glyphicon-off"></i> Salir</a>
              <a class="btn btn-info btn-xs" href="./../../general/vistas/vista.consulta.php?mod=17" target="jobFrame">
			  	  <i class="fa fa-binoculars"></i>  Consulta General</a>
                <?php
}?>
            </div>
