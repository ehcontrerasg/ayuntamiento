...
//pasamos variables por post
    ...
    <div id="content" style="padding:0px">
        ...
        <form name="asignalotlec" action="vista.asignacionfac.php" method="post" >
            <h3 class="panel-heading" style=" background-color:#A77B25; color:#FFFFFF; font-size:18px; width:1120px" align="center">Asignaci&oacute;n Lote Facturas</h3>
                        ...
                        <td align="left" width="5%" bgcolor="#EBEBEB">
                            <select name='proyecto' class='btn btn-default btn-sm dropdown-toggle' required onChange='recarga();' >
                                ...
                                while (oci_fetch($resultado)) {
                                    ...
                                    $sigla_proyecto = oci_result($resultado, 'DESC_PROYECTO') ;
                ...
                <table width="49%" border="1" bordercolor="#CCCCCC" align="left" vspace="12" >
                    ...
                    <tr>
                        <td colspan="3" bgcolor="EBEBEB" align="center">
                            <input type="submit" value="Asignar" name="Asignar" id="Asignar" class="btn btn-primary btn-lg" style="background-color:#A77B25;border-color:#A77B25">
                        </td>
                    </tr>
                </table>
                <table width="49%" border="1" bordercolor="#CCCCCC" align="right" vspace="12">
                    ...
                    <tr>
                        <td colspan="4" bgcolor="EBEBEB" align="center">
                            <input type="submit" value="Des-Asignar" name="Desasignar" id="Desasignar" class="btn btn-primary btn-lg" style="background-color:#A77B25;border-color:#A77B25">
                        </td>
                    </tr>
                </table>
            </div>
