...
<body style="margin-top:-25px" >
	<div class="flexigrid" >
		<h3 class="panel-heading" style=" background-color:#A77B24; color:#FFFFFF; font-size:18px; width:800px; font-family:'Times New Roman', Times, serif" align="center">
		...
		<div style="display: block;float: left">
			...
			<table cellpadding="0" cellspacing="0" align="center" width="40%">
				<tr>
					<td>
						<fieldset class="fieldset_diferido" style="color: #A77B24;width:290px">
					...
					<td>	
						<fieldset class="fieldset_diferido" style="color: #A77B24;width:290px">
							...
							<table align="center" cellpadding="0" cellspacing="0" >
								<tr>
									<td align="center">
										<button style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#A77B24; color:#A77B24" type="submit" name="procesar" id="procesar"class="btn btn btn-INFO"><i class="fa fa-refresh"></i><b>&nbsp;Generar Acuerdo de Pago</b>
										</button>
									</td>
								</tr>
							</table>
