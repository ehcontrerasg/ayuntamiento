...
if ($verificarPermisos==true): ?>
    ...
    include '../../catastro/clases/class.inmueble.php';
    include '../../catastro/clases/class.proyecto.php';
    include '../../catastro/clases/class.urbanizacion.php';
    include '../../catastro/clases/class.via.php';
    include '../../catastro/clases/class.parametros.php';
    include '../../catastro/clases/class.nombrevia.php';
    include '../../catastro/clases/class.sector.php';
    include '../../catastro/clases/class.ruta.php';
    include '../../catastro/clases/class.zona.php';
    include '../../catastro/clases/class.uso.php';
    include '../../catastro/clases/class.actividad.php';
    include '../../catastro/clases/class.medidor.php';
    include '../../catastro/clases/class.suministro.php';
    include '../../catastro/clases/class.emplazamiento.php';
    include '../../catastro/clases/class.concepto.php';
    include '../../catastro/clases/class.tarifa.php';
    include '../../catastro/clases/class.calculo.php';
    include '../../catastro/clases/class.medidor_inmueble.php';
    include '../../catastro/clases/class.concepto_inmueble.php';
    include '../../catastro/clases/class.grupo.php';
    ...
    <form  id="agregainm" name="agregainm" onSubmit="return infomante();" action="vista.actualizarinmueble.php" autocomplete="on" method="post"  class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <center><div class="panel panel-primary" style="border-color:rgb(163,73,163)">
                <h3 class="panel-heading" style="background-color:#A77B25; border-color:#A77B25"> Actualizar datos Inmueble</h3>

                <div class="panel_mody" >Diligencie la informaci&oacute;n del formulario.
                    <div class="container">
                        <p><p>

                        <h3 style="background-color:#A77B25; font-size:13px; color:white; text-align:left"><b>&nbsp;&nbsp;&nbsp;Datos B&aacute;sicos</b></h3>
                        <div class="row" >
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="text-align:left">
                                ...
                                <span class="input-group-addon"><input type="text" class="form-control taminputs2" value="<?php echo $id_proyecto;?>"  readonly ></input></span>
                                </span>
                            </div>
                ...
                ?>
                        ...
                        <h3 style="background-color:#A77B25; font-size:13px; color:white; text-align:left"><b>&nbsp;&nbsp;&nbsp;Informaci&oacute;n Vial</b></h3>
                ...
                ?>
                        ...
                        <h3 style="background-color:#A77B25; font-size:13px; color:white; text-align:left"><b>&nbsp;&nbsp;&nbsp;Datos Inmueble</b></h3>
                        <div class="row" >
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="text-align:left">
                      ...
                      /* if($codcargo==1 or $codcargo==2 or $codcargo==3 or $codcargo==5){
                       ...
                       ?>
                        ...
                        <p>
                        <center><input type="submit" value="Agregar" class="btn btn-primary btn-lg" style="background-color:#A77B25;border-color:#A77B25">&nbsp;&nbsp; <a class="btn btn-primary btn-lg" href="#" role="button" style="background-color:#A77B25;border-color:#A77B25">Cancelar</a></center></p></center></p>
