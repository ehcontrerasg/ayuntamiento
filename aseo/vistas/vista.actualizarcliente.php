...
if ($verificarPermisos==true): ?>
    ...
    <form  action="vista.actualizarcliente.php?" autocomplete="on" method="post" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-primary" style="border-color:rgb(163,73,163)">
            <h3 class="panel-heading" style="background-color:rgb(167,123,37);border-color:rgb(167,123,37)"><center>Actualizar Cliente</center> </h3>
            ...
            <center>
                ...
                <a>
                    <input type="submit" value="Actualizar" class="btn btn-primary btn-lg" style="background-color:rgb(167,123,37);border-color:rgb(167,123,37)">
                </a>&nbsp;&nbsp;
