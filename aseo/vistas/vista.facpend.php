...
<head>
	...
	<link href="../../font-awesome/css/font-awesome.min.css" rel="stylesheet" />
	 <script type="text/javascript" src="../js/datFacturasRel.js?3"></script>
...
<div id="content" style="padding:0px; width:1120px; margin-left:0px">
	<h3 class="panel-heading" style=" background-color:#A77B24; color:#FFFFFF; font-size:18px; width:1120px" align="center">Reliquidaci&oacute;n de Facturas</h3>
