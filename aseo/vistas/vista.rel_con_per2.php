...
<div id="content" class="flexigrid" >
	...
	<div class="panel panel-primary" style="border-color:#A77B24">
		<h3 class="panel-heading" style="background-color:#A77B24;border-color:#A77B24"><center>Reliquidaci&oacute;n por Concepto</center> </h3>
		<div class="panel_mody" ><center></center></div>
		<h3 style="background-color:#A77B24; font-size:13px; color:white; text-align:center">&nbsp;&nbsp;&nbsp;Datos De La Reliquidaci&oacute;n</h3>
...
<?php
    ...
    while (oci_fetch($registros)) {
        ...
        //}
            ...
            <tr>
                <th class="th"><b>Observacion</b></th>
            ...
            <tr>
                <td class="tda" align="center" colspan="4">
                    <button type="submit" name="procesar" id="procesar"
                            style="background:linear-gradient(#D8D8D8,#FFFFFF,#FFFFFF,#D8D8D8);border-color:#A77B24; color:#A77B24" class="btn btn btn-INFO">
