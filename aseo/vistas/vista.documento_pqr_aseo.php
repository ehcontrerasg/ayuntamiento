...
while (oci_fetch($resultado)) {
    ...
    $telcliente    = oci_result($resultado, "TEL_CLIENTE_NUEVO");
    ...
    $email         = oci_result($resultado, "EMAIL_CLIENTE_NUEVO");
    ...
    if ($acueducto == 'SD') {
        ...
        $pdf->Text(38, 15,utf8_decode( "AYUNTAMIENTO DE SANTO DOMINGO ESTE"));
    ...
    if ($acueducto == 'BC') {
        $pdf->SetFont('Helvetica', 'B', 11);
        $pdf->Text(38, 15, utf8_decode("AYUNTAMIENTO DE BOCACHICA"));
        $pdf->Text(92, 22, "GERENCIA COMERCIAL");
        $pdf->Text(58, 29, utf8_decode("CONSTANCIA DE RECEPCIÓN DE RECLAMOS Y SOLICITUDES"));
    ...
    $pdf->Ln(4);
    $pdf->Cell(190, 5, utf8_decode("al  telefono (809) 598-1722 Opción 1."), 0, 0, 'L');
    $pdf->Ln(6);
    $pdf->SetFont('Arial', 'B', 8);
