...
<body style="margin-top:-25px" onload="document.getElementById('cod_inmueble').focus();">
	...
	?>
		<h3 class="panel-heading" style=" background-color:#000040; color:#FFFFFF; font-size:18px; width:1120px" align="center">Recepci&oacute;n de PQRs</h3>
						...
						<table>
							<tr>
							  ...
							  <td width="172">
								...
								if($facpend > 0){
									?>
									<a href="JAVASCRIPT:hisfac(<?php echo $cod_inmueble?>);">
									<i class="fa fa-book fa-lg" style="color:#000000"></i></a>
								<?php
								}
								?>
							  </td>
							  <td width="172">
								Fact Entregadas<br />
								<input type="text" name="facent" id="facent" value="<?php echo $facent;?>" size="5"  readonly class="input" style="color:#FF0000"  />
								<?php
								if($facent > 0){
									?>
									<a href="JAVASCRIPT:hisfacent(<?php echo $cod_inmueble?>);">
									<i class="fa fa-book fa-lg" style="color:#000000"></i></a>
								<?php
								}
								?>
							  ...
							  <td width="172">
								Observaciones<br />
									...
									<a href="JAVASCRIPT:observaciones(<?php echo $cod_inmueble?>);">
									<i class="fa fa-file-text fa-lg" style="color:#000000"></i></a>
                                ...
                                <td width="172">
                                    Datos Totalizador<br />

                                    <a href="JAVASCRIPT:totalizador(<?php echo $cod_inmueble?>);">
                                        <i class="fa fa-file-text fa-lg" style="color:#000000"></i></a>
							 ...
							 <tr>
							 	<td width="172" colspan="3">
									...
									if($cantrec > 0){
										?>
										Historico de Reclamos<br />
										<input type="text" name="cantrec" id="cantrec" value="<?php echo $cantrec;?>" size="5"  readonly class="input" style="color:#FF0000"  />
										<a href="JAVASCRIPT:hiscanrec(<?php echo $cod_inmueble?>);">
										<i class="fa fa-book fa-lg" style="color:#000000"></i></a>
									<?php
									}
									?>
                                 ...
                                 <td width="172">
                                     ...
                                     <input type="text"  value="<?php echo $ger_inm;?>" size="20" maxlength="20" readonly class="input"/>


                                 </td>
							   	<td width="172" colspan="5" align="right">
									<p>
								   	<?php
									$c = new PQRs();
									...
									if($est_inm == 'SS'){
									 ...
									 <p><font color="#FF0000" size="3px" >Pago por reconexi&oacute;n pendiente. RD$ <?php echo number_format($tarifa_reco,0,',','.');?></font>
									   <?php
									}
									?>
						            </p>
