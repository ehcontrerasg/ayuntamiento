...
if ($verificarPermisos==true): ?>
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        <h3 class="panel-heading" style=" background-color:#000040; color:#FFFFFF; font-size:18px; width:1120px" align="center">Tipos de PQRs</h3>
                ...
                $("#flex1").flexigrid	(
                    {
                        ...
                        colModel : [
                            ...
                            {display: 'Descripci&oacute;n', name: 'mes', width: 180, sortable: true, align: 'center'}
                        ],

                        buttons: [
                            {name:'Agregar Tipo', bclass:'add', onpress: test},
                            {separator: true},
                            {name:'Eliminar Tipo', bclass:'delete', onpress: test},
                            {separator: true}
                        ],
                        searchitems : [
                        ...
                        sortorder: "DESC",
                        usepager: true,
                        title: 'Listado de Tipos De PQRs',
                        useRp: true,
                        rp: 30,
                        page: 1,
