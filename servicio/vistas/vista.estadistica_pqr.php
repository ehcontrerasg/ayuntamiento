...
if ($verificarPermisos==true): ?>
    ...
    <head>
        ...
        <title>Reporte De Estadistica de PQRs Resumido</title>
        ...
        <!--logica pag    -->
        <script type="text/javascript" src="../js/repEstPqr.js?<? echo time();?>"></script>
    </head>
    <body>
    <header>
        <div class="cabecera">
            Reporte De Estadistica de PQRs Resumido
        </div>
    </header>
    <section>
        <article>
            <form onSubmit="return false" id="genRepEstPqrForm">
                <div class="subCabecera">
                    Filtros de Búsqueda Reporte De Estadistica de PQRs Resumido
                </div>
                <div class="divfiltros">
                    <div class="contenedor">
                        <label> Proyecto: </label>
                        <select id="selProyEstPqr" name="proyecto"></select>
                    </div>
                    <div class="contenedor">
