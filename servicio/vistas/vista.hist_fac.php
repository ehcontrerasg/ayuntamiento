...
if ($verificarPermisos==true): ?>
    ...
    <body style="width: 92%">
    <form name="FMTarifas" action="vista.hist_fac.php" method="post" onsubmit="return rend();">
        <div class="flexigrid" style="width:450px">
        ...
        $("#flex1").flexigrid	(
            {
                ...
                url: './../datos/datos.histfact.php?inmueble=<?php echo $inmueble;?>',
                ...
                colModel : [
                    ...
                    {display: 'Fecha Vcto', name: 'FECHAVCO', width: 90, sortable: true, align: 'center'}
                ],
