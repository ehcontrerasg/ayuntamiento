...
<header>
    <div style=" background-color: #000040;padding: 0.5px;margin: 4px;color:#FFFFFF;"><center><h4>Servicio de pagos recurrentes</h4></center></div>
</header>
<body>
    ...
    padding-bottom: 5px;">
        <form onsubmit="return false" id="frmRegistroTarjeta" >
            <div class="form-group col-sm-2">
                ...
                <input type="text" name="codigo_inmueble" id="txtCodigoInmueble" class="form-control" pattern= "[0-9]{4,8}" maxlength="10" title="Campo numérico de ocho o menos digitos." tabindex="-1" required>
            </div>
            <div class="form-group col-sm-2">
            ...
            <div class="form-group col-sm-3">
                ...
                <input type="text" class="form-control" id="txtNombreCliente" name="nombre_cliente" readonly="">
            </div>
            <div class="form-group col-sm-2">
                <label  for="txtTelefono">Teléfono</label>
                <input type="text" name="telefono" id="txtTelefono" class="form-control" tabindex="6" required>
            </div>
            <div class="form-group col-sm-2">
                <label  for="txtTelefono">Celular</label>
                <input type="text" name="celular" id="txtCelular" class="form-control" tabindex="7"  required>
            </div>
            <div class="form-group col-sm-2">
    ...
    <div style="width: 363px;box-shadow: 0px 0px 4px 0px;margin-left: 69%;margin-top: 10px;">
        <div class="form-group">
            <div class="row" style=" padding: 12px;">
                <label class="col-sm-4" style="">Buscar:</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frmAnularPago" onsubmit="return false">
                        ...
                        <input type="hidden" id="codigoInmueble">
                          <div class="form-group">
                            <label for="txtCodigoInmueble">Código de inmueble:</label>
                            <input type="text"   class="form-control" id="txtCodigoInmuebleAnulacion" readonly />
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-primary" id="btnAnularServicio" value="Guardar">
                    </form>
                </div>
            </div>
        </div>
...
<script src="../../recaudo/js/registroTarjeta.js?<?echo time();?>"></script>
</html>
<?php endif;
