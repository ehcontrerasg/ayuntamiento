...
if ($verificarPermisos==true): ?>
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        ...
        ?>
        <h3 class="panel-heading" style=" background-color:#000040; color:#FFFFFF; font-size:18px; width:1120px" align="center">Recepcion de Reclamos, Solicitudes y Consultas</h3>
                    ...
                    <div style="background: linear-gradient(#F7F7F7,#F7F7F7); border-top:1px solid #ccc;" align="left">
                        <table width="1231">
                            <tr>
                                ...
                                <td>
                                    <!-- button class="btn btn-primary" id="btnSolCerradas">
                                        <span class="glyphicon glyphicon-search"></span> Buscar Solicitudes
                                    </button -->
    ...
    <div id="conSolCerradas" class="container-fluid">
        ...
        <!-- script type="text/javascript" src="../../js/facturaspendientes.js?1"></script -->
