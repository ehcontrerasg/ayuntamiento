    ...
    <section class="contenido">
        <article>
            <form onsubmit="return false" id="regNueConForm">
                ...
                <div class="subCabecera fondSerCli"> Datos Deuda</div>
                <span class="datoForm col1">
                ...
                <!--/span>
                <span class="datoForm col1"-->
                    <span class="titDato numCont1">Total a pagar (Inicial + Reconexion) ($RD)</span>
                    <span class="inpDatp numCont1"><input  id="ingNueConValTotal" required placeholder="Total a Pagar" readonly type="text"></span>
                </span>
                <span class="datoForm col1">
                    <input type="submit"  value="Generar Acuerdo" class="botonFormulario botFormSerCli"  id="ingNueConBut">
                </span>
            </form>
