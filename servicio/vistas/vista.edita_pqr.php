...
//pasamos variables por post
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        ...
        ?>
        <h3 class="panel-heading" style=" background-color:#000040; color:#FFFFFF; font-size:18px; width:760px" align="center">Resoluci&oacute;n de PQRs</h3>
                    ...
                    <div style="background: linear-gradient(#F7F7F7,#F7F7F7); border-top:1px solid #ccc;" align="left">
                        <table>
                            ...
                            while (oci_fetch($resultado)) {
                                ...
                                $user_com = oci_result($resultado, 'LOGIN') ;
                                $cont++;
                                if($desc_com <> ''){
                                    ?>
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <input type="text" size="10" value="<?php echo $user_com?>" readonly />&nbsp;&nbsp;
                                            <input type="text" size="75" value="<?php echo $desc_com?>" readonly/>
                                        </td>
                                    </tr>
                                    <?php
                                }
