...
if ($verificarPermisos==true): ?>
    ...
    <div id="content" style="padding:0px; width:1120px; margin-left:0px">
        <h3 class="panel-heading" style=" background-color:#000040; color:#FFFFFF; font-size:18px; width:1120px" align="center">Motivos PQRs</h3>
                ...
                $("#flex1").flexigrid	(
                    {
                        ...
                        colModel : [
                            ...
                            {display: 'Motivo', name: 'agno', width: 50, sortable: true, align: 'center'},
                            {display: 'Tipo PQR', name: 'mes', width: 100, sortable: true, align: 'center'},
                            {display: 'Area', name: 'dia', width: 120, sortable: true, align: 'center'},
                            {display: 'Dias<br>Resolucu&oacute;n', name: 'fecha', width: 100, sortable: true, align: 'center'}
                        ],

                        buttons: [
                            {name:'Agregar Motivo', bclass:'add', onpress: test},
                            {separator: true},
                            {name:'Eliminar Motivo', bclass:'delete', onpress: test},
                            {separator: true}
                        ],
                        searchitems : [
