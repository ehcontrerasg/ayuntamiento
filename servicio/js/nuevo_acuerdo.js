...
$(document).ready(function(){
    ...
    $("#ingNueConValIni").blur(
        function (){
            $("#ingNueConValTotal").val( (Math.round($("#ingNueConValIni").val()) + Math.round($("#ingNueConRec").val())));
...
function verificaReconexion(estado){
    ...
    ({
        ...
        success : function(json) {
            ...
            totalPagar= (Math.round($("#ingNueConValIni").val()) + Math.round($("#ingNueConRec").val()));
...
function imprimeAcuerdoNuevo()
{
    ...
    xmlhttp.open("POST", "../reportes/reporte.NuevoAcuerdo.php", true);   // async
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
