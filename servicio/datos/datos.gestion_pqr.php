...
if (isset($_GET['tipomov'])) {
    $l         = new PQRs();
    $registros = $l->seleccionaMotivoPqr($_GET['tipo']);
    ...
    $l       = new PQRs();
    $valores = $l->CantidadRegistrosPqr($proyecto, $departamento, $secini, $secfin, $rutini, $rutfin, $fecini, $fecfin, $cod_inmueble, $codpqr, $tipo_pqr, $motivo_pqr, $where);
    ...
    $l         = new PQRs();
    $registros = $l->obtenerDatosPQRs($proyecto, $departamento, $secini, $secfin, $rutini, $rutfin, $fecini, $fecfin, $cod_inmueble, $codpqr, $start, $end, $tipo_pqr, $motivo_pqr, $where);
    $json      = "";
    $json .= "{\n";
    $json .= "page: $page,\n";
    $json .= "total: $total,\n";
    ...
    while (oci_fetch($registros)) {
        ...
        $estado        = oci_result($registros, 'CERRADO');
        ...
        if ($dias_faltan > 0) {
            $json .= ",'<b><font color=#00CC00>" . $dias_faltan . "</font></b>'";
        } else {
            $json .= ",'<b><font color=#FF0000>" . $dias_faltan . "</font></b>'";
        }
        ...
        if ($area_user == '9' || $area_user == '6') {
            ...
            $json .= ",'<a href=javascript:modifica_pqr($codigo_pqr);><img src=../../images/edit2.png width=15px height=15px title=Edicion /></a>'";
        }
