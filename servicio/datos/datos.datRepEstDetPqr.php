...
if ($tipo == 'EstPqr') {
   /* require_once '../clases/PHPExcel.php';*/
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->SetCellValue('M3', 'Descripcion')
        ->SetCellValue('N3', 'Tiempo Respuesta (días hábiles)');
    ...
    $objPHPExcel->setActiveSheetIndex(0)->getStyle('K4:N' . $fila)->applyFromArray($borderArray3);
    ...
    $objPHPExcel->setActiveSheetIndex(0)->getColumnDimension("I")->setWidth(12.72);
    ...
    // Fuentes en Bold
    $objPHPExcel->setActiveSheetIndex(0)->getStyle('A1:N3')->getFont()->setBold(true);

    // Estilo y size de las fuentes
    $objPHPExcel->setActiveSheetIndex(0)->getStyle("A1")->getFont()
        ->setName('Tahoma')
        ->setSize(18);
    $objPHPExcel->setActiveSheetIndex(0)->getStyle("A2:N2")->getFont()
        ->setName('Tahoma')
        ->setSize(11)
        ->getColor()->setRGB('ffffff');
    $objPHPExcel->setActiveSheetIndex(0)->getStyle("A4:N" . $fila)->getFont()
        ->setName('Tahoma')
        ->setSize(9);
    ...
    $objPHPExcel->setActiveSheetIndex(0)->getStyle('A3:N' . $fila)->applyFromArray(
        array(
            'alignment' => array(
                'horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER,
                'vertical'   => PHPExcel_Style_Alignment::VERTICAL_CENTER,
    ...
    $objPHPExcel->setActiveSheetIndex(0)->getStyle('A1:N3')->applyFromArray($estiloTitulos);
