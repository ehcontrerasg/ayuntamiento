...
-->    <!-- End page background -->
    ...
    <div id='tg_1' class='t s4'><b>Cedula de identidad: </b>".formatCedula($datos_cliente["DOCUMENTO"])."</div>
    ...
    <div id='tt_1' class='t s1'><b>Firma del Usuario: <input type='text'  size='100'/> </b></div>
...
<a download='FO-REC-25._PAGO_RECURRENTE_CAASD_V.4.pdf' href='https://cloud.idrsolutions.com/online-converter/output/54a8d782-051b-42a3-9961-a1c2978f4668/FO-REC-25._PAGO_RECURRENTE_CAASD_V.4/form.html'></a></body></html>";
