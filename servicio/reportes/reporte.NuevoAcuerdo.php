...
if($acueducto == 'SD') {
    $pdf->Cell(10, 5, utf8_decode('La CAASD acuerda reducir la deuda a RD$ ' . $totalpagarf), 0, 3, 'L', false);
}
else{
    $pdf->Cell(10, 5, utf8_decode('CORAABO acuerda reducir la deuda a RD$ ' . $totalpagarf), 0, 3, 'L', false);
}
$posy += 6;
...
if ($acueducto == 'SD') {
    $pdf->Cell(10, 5, utf8_decode('La violación  al presente convenio  faculta a la CAASD a  suspender el servicio, requiriendo  para su reinstalación el pago total'), 0, 3, 'L', false);
}
else{
    $pdf->Cell(10, 5, utf8_decode('La  violación  al presente convenio  faculta a CORAABO a  suspender el servicio, requiriendo  para su reinstalación el pago total'), 0, 3, 'L', false);
}
$posy += 6;
$pdf->SetY(98 + $posy); $pdf->SetX(10);
