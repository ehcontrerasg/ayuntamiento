...
$vEdition = $v->compEdition($id, '2018/03/13');
$pdf->AddPage();
...
if ($vEdition) {
    $pdf->Text(186, 22.5, '03');
    $pdf->Text(163.8, 32.5, '13-03-2018');
} else {
    $pdf->Text(186, 22.5, '02');
    $pdf->Text(163.8, 32.5, '23-08-2017');
}
...
$pdf->Rect(26, $y + 93, 3.5, 3.5, $p1);
$pdf->Rect(64.8, $y + 93, 3.5, 3.5, $p2);
$pdf->Rect(106.8, $y + 93, 3.5, 3.5, $p3);
$pdf->Rect(152.6, $y + 93, 3.5, 3.5, $p4);

$pdf->SetFont('helvetica', '', 9);
$pdf->Text(32.7, $y + 95.8, 'Alta');
$pdf->Text(71.5, $y + 95.8, 'Media');
$pdf->Text(113.5, $y + 95.8, 'Baja');
...
$pdf->Text(145.7, $y + 218.3, utf8_decode(''));
$pdf->Text(145.7, $y + 227.3, utf8_decode(''));
